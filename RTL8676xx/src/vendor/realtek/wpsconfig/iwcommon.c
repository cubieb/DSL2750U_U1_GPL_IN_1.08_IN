...
#include "1x_common.h"	//2003-06-13
...
void iw_message( int type, char * msg, ... )
...
void iw_hexdump(int type, char *fun, u_char *buf, int size, char *comment)

{
        int i;


	iw_message(type, "$$ %s $$: %s", fun, comment);
...
void iw_ctldump(char *fun, u_char *buf, int size, char *comment)
