...
#define MAX_NUMBER_OF_DEVICE 			3
#define MAX_NUMBER_OF_Service 			30//10 //cathy
#define DLNA_BYEBYE_FILE				("/tmp/dlna_byebye")
#define WSCD_BYEBYE_FILE				("/tmp/wscd_byebye")
#define IGD_BYEBYE_FILE					("/tmp/igd_byebye")

enum { DEVICE_UNUSED=0, DEVICE_IGD=1, DEVICE_WSC=2, DEVICE_DLNA=3 };
