...
ADD_APPL_CFLAGS="-DMODULE -O1 -G 0 -mlong-calls \
...
./build.sh $SCRIPT $1 --arch=mips --device=amazon-se --inc-debug=1 --inc-soap=1 \
    --inc-debug-prints=1 --inc-cli=1 --inc-script=1 \
    --add-appl-cflags="$ADD_APPL_CFLAGS" --inc-dsl-pm=1 \
