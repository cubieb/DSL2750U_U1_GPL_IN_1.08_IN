...
#ifndef _DSL_CPE_DEBUG_VINAX_H
#define _DSL_CPE_DEBUG_VINAX_H
...
/*#define WINHOST_REMOTE_BYTE_ORDER   DSL_BIG_ENDIAN*/
...
#define P_CMV_MSGHDR_RESULT_CODE_SET(pmsg, val) pmsg->header.MessageID = \
         ( (pmsg->header.MessageID & ~(CMV_RESPONSE_RESULT_CODE_MASK)) | \
...
#define CMV_MSGHDR_RESULT_CODE_SET(msg, val) msg.header.MessageID = \
         ( (msg.header.MessageID & ~(CMV_RESPONSE_RESULT_CODE_MASK)) | \
           ((val << CMV_RESPONSE_RESULT_CODE_POS) & ~(CMV_RESPONSE_RESULT_CODE_MASK)) )
