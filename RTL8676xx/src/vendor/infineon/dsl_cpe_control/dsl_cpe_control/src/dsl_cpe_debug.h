...
*/
#define DSL_CCA_DBG_MAX_LEVEL DSL_CCA_DBG_MSG
...
#define  DSL_CCA_DBG_PRINTF (void) DSL_debug_printf
...
{ \
   ...
   { \
      ...
      DSL_CCA_DBG_PRINTF(DSL_NULL, ":Line %i:" DSL_CRLF,__LINE__); \
...
{ \
   ...
   { \
      ...
      DSL_CCA_DBG_PRINTF_FUNCTION; \
      DSL_CCA_DBG_PRINTF(DSL_NULL, ":Line %i:" DSL_CRLF,__LINE__); \
      DSL_CCA_DBG_PRINTF(DSL_NULL, "Assertion failed." DSL_CRLF ); \
      while(1) ; \
   } \
}
