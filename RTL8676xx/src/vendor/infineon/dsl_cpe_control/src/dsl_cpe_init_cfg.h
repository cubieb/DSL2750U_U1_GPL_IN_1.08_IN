...
#define DSL_CPE_AUTOBOOT_CFG_SET(opt) {{opt}}
...
#define DSL_CPE_LL_CFG_SET(RXTXGAINSEL, RXGAIN, TXGAIN, CLOCKOUT, FILTER, \
   ...
   UTOPIAADDR, POSPHYPARITY, POSPHYADDR, POSPHYCHUNKSIZE) \
...
#define DSL_CPE_MAC_CFG_SET(SPEED, DUPLEX, FLOW, ANEGOT)   {SPEED, DUPLEX, FLOW, ANEGOT}
...
*/
DSL_Error_t DSL_GetInitialLowLevelConfig( DSL_char_t const *pName,
