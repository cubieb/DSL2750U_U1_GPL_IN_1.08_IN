...
#define DEFAULT_TS1			30/*2.5*/		/* Time (in seconds) after which contiguous LOS defect could be declared as a LOS failure */
#define DEFAULT_TS2			2/*10*/		/* Time (in seconds) after which LOS failure could be cleared  with NO LOS defect */
#define DEFAULT_TF1			2.5		/* Time (in seconds) after which contiguous LOF defect could be declared as a LOF failure */
#define DEFAULT_TF2			10		/* Time (in seconds) after which LOF failure could be cleared  with NO LOF defect */
