...
#ifdef CO_30
  #define QUAD0_BASE_ADDR       0xe0098000
  #define QUAD1_BASE_ADDR       0xf0098000
#endif  // CO_30
...
#define PFSAR    0x235                // [47:40] bits of the SA for P/R F
#define PFCR0    0x236                // PF CRC [15: 0]
#define PFCR1    0x237                // PF CRC [31:16]
#define RFCRR0   0x238                // RF CRC [15: 0]
#define RFCRR1   0x239                // RF CRC [31:16]
...
// Pointer/status regs
#define TFRPR    0x240                // Tx_Fifo Read Pointer Register
#define TFWPR    0x241                // Tx_Fifo Write Pointer Register
#define RFRPR    0x242                // Rx_Fifo Read Pointer Register
#define RFWPR    0x243                // Rx_Fifo Write Pointer Register
#define TSOFPR   0x244                // Tx Start Of Frame Pointer Register
#define RSOFPR   0x245                // Rx Start Of Frame Pointer Register
...
#if 0 //#ifdef CO_30
#define FTSCR0   0x25a                // Frame too short counter reg 0
#define FTSCR1   0x25b                // Frame too short counter reg 1
#endif
...
#ifdef CO_30
#define USGCR      0x000              // Utopia Slave Global control register
#define USRSR      0x001              // Utopia Slave Rx Soft Reset Register
#define USUDF      0x002              // Utopia Slave UDF register

#define USTILV     0x040              // Utopia Slave Tx Interleave control reg.
//quad 0
#define USTILV_0   0x040              // Utopia Slave Tx Interleave control reg. 0
#define USTILV_1   0x041              // Utopia Slave Tx Interleave control reg. 1
#define USTILV_2   0x042              // Utopia Slave Tx Interleave control reg. 2
#define USTILV_3   0x043              // Utopia Slave Tx Interleave control reg. 3
//quad 1
#define USTILV_4   0x044              // Utopia Slave Tx Interleave control reg. 4
#define USTILV_5   0x045              // Utopia Slave Tx Interleave control reg. 5
#define USTILV_6   0x046              // Utopia Slave Tx Interleave control reg. 6
#define USTILV_7   0x047              // Utopia Slave Tx Interleave control reg. 7

#define USTFST     0x048              // Utopia Slave Tx Fast control reg.
//quad 0
#define USTFST_0   0x048              // Utopia Slave Tx Fast control reg. 0
#define USTFST_1   0x049              // Utopia Slave Tx Fast control reg. 1
#define USTFST_2   0x04a              // Utopia Slave Tx Fast control reg. 2
#define USTFST_3   0x04b              // Utopia Slave Tx Fast control reg. 3
//quad 1
#define USTFST_4   0x04c              // Utopia Slave Tx Fast control reg. 4
#define USTFST_5   0x04d              // Utopia Slave Tx Fast control reg. 5
#define USTFST_6   0x04e              // Utopia Slave Tx Fast control reg. 6
#define USTFST_7   0x04f              // Utopia Slave Tx Fast control reg. 7

#define USRILV     0x080              // Utopia Slave Rx Interleave control reg.
//quad 0
#define USRILV_0   0x080              // Utopia Slave Rx Interleave control reg. 0
#define USRILV_1   0x081              // Utopia Slave Rx Interleave control reg. 1
#define USRILV_2   0x082              // Utopia Slave Rx Interleave control reg. 2
#define USRILV_3   0x083              // Utopia Slave Rx Interleave control reg. 3
//quad 1
#define USRILV_4   0x084              // Utopia Slave Rx Interleave control reg. 4
#define USRILV_5   0x085              // Utopia Slave Rx Interleave control reg. 5
#define USRILV_6   0x086              // Utopia Slave Rx Interleave control reg. 6
#define USRILV_7   0x087              // Utopia Slave Rx Interleave control reg. 7

#define USRFST     0x088              // Utopia Slave Rx Fast control reg.
//quad 0
#define USRFST_0   0x088              // Utopia Slave Rx Fast control reg. 0
#define USRFST_1   0x089              // Utopia Slave Rx Fast control reg. 1
#define USRFST_2   0x08a              // Utopia Slave Rx Fast control reg. 2
#define USRFST_3   0x08b              // Utopia Slave Rx Fast control reg. 3
//quad 1
#define USRFST_4   0x08c              // Utopia Slave Rx Fast control reg. 4
#define USRFST_5   0x08d              // Utopia Slave Rx Fast control reg. 5
#define USRFST_6   0x08e              // Utopia Slave Rx Fast control reg. 6
#define USRFST_7   0x08f              // Utopia Slave Rx Fast control reg. 7
...
#ifdef CO_30
  #define MMDI_WDAT    0x0dc              // MDIO Master Write data register
  #define MMDI_ADD     0x0dd              // MDIO Master address register
  #define MMDI_RD      0x0de              // MDIO Master Read register
  #define MMDI_OP      0x0df              // MDIO Master Operation register
  #define MMDI_RDAT    0x0e0              // MDIO Master Read data register

  #define MDIO_OP_READ  0x01              // Register bit definition (Bit 0)
  #define MDIO_OP_WRITE 0x02              // Register bit definition (Bit 1)

  #define SMDI_CTL     0x0e4              // MDIO Slave control register
  #define SMDI_CTL_0   0x0e4              // MDIO Slave control register 0
  #define SMDI_CTL_1   0x0e5              // MDIO Slave control register 1
  #define SMDI_CTL_2   0x0e6              // MDIO Slave control register 2
  #define SMDI_CTL_3   0x0e7              // MDIO Slave control register 3
  #define SMDI_CTL_4   0x0e8              // MDIO Slave control register 4
  #define SMDI_CTL_5   0x0e9              // MDIO Slave control register 5
  #define SMDI_CTL_6   0x0ea              // MDIO Slave control register 6
  #define SMDI_CTL_7   0x0eb              // MDIO Slave control register 7

  #define SMDI_STAT    0x0ec              // MDIO Slave status register
  #define SMDI_STAT_0  0x0ec              // MDIO Slave status register 0
  #define SMDI_STAT_1  0x0ed              // MDIO Slave status register 1
  #define SMDI_STAT_2  0x0ee              // MDIO Slave status register 2
  #define SMDI_STAT_3  0x0ef              // MDIO Slave status register 3
  #define SMDI_STAT_4  0x0f0              // MDIO Slave status register 4
  #define SMDI_STAT_5  0x0f1              // MDIO Slave status register 5
  #define SMDI_STAT_6  0x0f2              // MDIO Slave status register 6
  #define SMDI_STAT_7  0x0f3              // MDIO Slave status register 7

  #define SMDI_GSTAT   0x0f4
#endif
