...
extern void	uiLogPortCounters(ipos_port_id pid, ipos_port_counters	*pPortCounters);
...
extern void uiLogPortPmCounters(ipos_port_id pid, ipos_pm_counters *pPmCntr);
