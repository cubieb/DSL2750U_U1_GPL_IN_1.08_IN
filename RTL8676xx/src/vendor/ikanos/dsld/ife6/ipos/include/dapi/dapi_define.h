...
/*Providing Call back function for Framing mode update*/
#define HPI_UPDATE_FRAMING_MODE   (0xE5)
/***************************************************************/
...
#define ADSL_T1E1_ISSUE_1  (1<<12)  //NOT supported any longer
#define ADSL_T1E1          (ADSL_T1E1_ISSUE_2)
#define VDSL_T1E1         (1<<16)
#define VDSL              (VDSL_T1E1)
#define VDSL1_ETSI         (1<<17)
#define VDSL_JAPAN        (1<<31)
...
#define ADSL2_ANNEX_M      (1<<10)
#define ADSL2_PLUS_ANNEX_A (1<<5)
#define ADSL2_PLUS_ANNEX_B (1<<6)
#define ADSL2_PLUS_ANNEX_M (1<<7)
#define ADSL2_ANNEX_L (1<<8)

#define VDSL_ANSI         (1<<16)
#define VDSL_ETSI         (1<<17)
#define VDSL_ITU_993_1     (1<<18)
#define VDSL_IEEE_802_AH   (1<<19)
...
#define VDSL1_TYPE_SUPPORTED (VDSL_T1E1 | VDSL1_ETSI|VDSL_ITU_993_1)
...
#define VDSL_TYPE_SUPPORTED (VDSL1_TYPE_SUPPORTED | VDSL2_TYPE_SUPPORTED)
#define LINE_TYPE_SUPPORTED ( ADSL1_TYPE_SUPPORTED| VDSL1_TYPE_SUPPORTED| VDSL2_TYPE_SUPPORTED )
 
#define VDSL2_ITU         VDSL2_TYPE_SUPPORTED	// VDSL2

//#define XDSL_AUTO_DETECT (ADSL1_ANNEX_A | ADSL1_ANNEX_B | ADSL2_PLUS_ANNEX_A | ADSL2_PLUS_ANNEX_B| ADSL2_PLUS_ANNEX_M | VDSL_T1E1 | VDSL2_ITU)
/*Setting only currently supported linetypes on CPE5*/
#define XDSL_AUTO_DETECT (ADSL1_ANNEX_A | ADSL2_PLUS_ANNEX_A | VDSL_T1E1 | VDSL2_ITU | ADSL2_ANNEX_A) /* Added ADSL2_ANNEX_A for auto detect for XDSL TT#340 */
#define VDSL_AUTO_DETECT (VDSL_T1E1 | VDSL2_ITU)

#define LINE_SELECTION_IKANOS (0)
#define LINE_SELECTION_DS_RATE (1)
#define LINE_SELECTION_US_RATE (2)
#define LINE_SELECTION_PRIORITY (3)
#define LINE_SELECTION_MAX (LINE_SELECTION_PRIORITY)
...
#define HPI_XMT_REVERB_RX_ECHO   (23)
#define HPI_XMT_MEDLEY_RX_ECHO   (24)
#define HPI_XMT_QUIET_RX_ECHO    (25)
