...
//JK- rfi		
    ...
    BYTE LineSelectionCriterion;

    BYTE PriorityTable[32];
		} PortProvParms;
...
typedef struct tPortParms 
    ...
    unsigned long  FeFecEs_S;             /* Far-end Forward Error Correction Errored Seconds (FEC ES) Slow count    */
    unsigned long  FeEs_S;                  /* Far-end Errored Seconds (ES) Slow count    */
    unsigned long  FeSEs_S;                /* Far-end Severely Errored Seconds (ES) Slow count    */
    unsigned long  FeLosEs_S;             /* Far-end LOS Errored Seconds (LOS ES) Slow count    */
    unsigned long  FeUnAvlEs_S;         /* Far-end Un Available Errored Seconds (UNAVL ES) Slow count    */
    unsigned long  FeBER_S;                /* Near-end Bit Error Rate (BER) Slow count             */
  ...
  struct tPmCounterParms
    ...
    UINT32 numIDLEcellBe_S;  //Number of Idle Cells Bit Error Slow count
    UINT32 numIDLEcellBe_F;  //Number of Idle Cells Bit Error Fast count

    UINT32 FeNumUSRcell_S;     //Far-end   Number of User Cells (USR) Slow count
    UINT32 FeNumUSRcell_F;     //Far-end   Number of User Cells (USR) Fast count
    UINT32 FeNumIDLEcell_S;    //Far-end   Number of Idle Cells (IDLE) Slow count
    UINT32 FeNumIDLEcell_F;     //Far-end   Number of Idle Cells (IDLE) Fast count
    UINT32 FeNumIDLEcellBe_S;  //Far-end   Number of Idle Cells Bit Error Slow count
    UINT32 FeNumIDLEcellBe_F;  //Far-end   Number of Idle Cells Bit Error Fast count
