...
typedef void    (* iposCbFramingModeUpdate) (ipos_port_id pid, U8 uid, U32 upar, int status, int FramingMode);
/*************************************************************************/
...
/*Providing Call back function for Framing mode update*/
extern int iposSetCbFramingModeUpdate(ipos_port_id  pid, U8 UID, iposCbFramingModeUpdate pCbFramingModeUpdate);
/*************************************************************************************/
