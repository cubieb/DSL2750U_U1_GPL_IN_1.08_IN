...
#define USE_VX180
#define USE_RTEMS
#define USE_SHARE_MEM_INTERFACE
#define EXCLUDE_NETWORK_TEST
#define LBIST_CMP_DATA(a)   (a & 0x0000fff0)
#elif defined (FUSIV_VX180)
#define USE_VX180
#define USE_FUSIV
#define USE_SHARE_MEM_INTERFACE
#define EXCLUDE_NETWORK_TEST
#define LBIST_CMP_DATA(a)   (a & 0x0000fff0)
#elif defined (VXWORKS_VX180)
#define USE_VX180
#define USE_VXWORKS           /* Comment this out to use other RTOS */
#define USE_SHARE_MEM_INTERFACE
#define EXCLUDE_NETWORK_TEST
#define LBIST_CMP_DATA(a)   (a & 0x0000fff0)
#else
#define USE_VXWORKS           /* Comment this out to use other RTOS */
#define USE_HIC_INTERFACE
#define LBIST_CMP_DATA(a)   ((a & 0x00003fff)>>2)
#endif
