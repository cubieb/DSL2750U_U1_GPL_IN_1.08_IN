...
#ifdef USE_SHARE_MEM_INTERFACE
extern unsigned int cpe_mem_start;
#define BME_RESET_VEC_CODE_DNLD_ADDR	(cpe_mem_start)
#define BME_CODE_DNLD_ADDR            (cpe_mem_start + 0x00010060)
#else
#define BME_RESET_VEC_CODE_DNLD_ADDR	0x40000000
#ifdef CPE_40 ///NUCLEUS
#define BME_CODE_DNLD_ADDR				0x40010060
#else
...
#if !defined(_PARALLEL_IO_INTERFACE_1) && !defined(USE_SHARE_MEM_INTERFACE)
