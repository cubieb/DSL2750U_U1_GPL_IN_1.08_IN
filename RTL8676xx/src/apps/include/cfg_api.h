...
#define MIN_FIRMWARE_SIZE		(unsigned long)32   	        //32 bytes
#define MAX_FIRMWARE_SIZE       (unsigned long)8*1024*1024      //8M bytes
#define MIN_CONFIG_SIZE 		(unsigned long)32 			    //32 bytes
