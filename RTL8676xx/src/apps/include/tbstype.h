...
#define MID_TR069HOLD   ((PID_CCP << 8) | 0x65)    /*tr069延迟执行代理模块*/
#define MID_GRE         ((PID_CCP << 8) | 0x67)    /*GRE模块 */
#define MID_IPV6ENABLE  ((PID_CCP << 8) | 0x68)     /* ipv6 enable*/
#define MID_MACCLONE    ((PID_CCP << 8) | 0x69)     /* MAC CLONE */

#define MID_IPSEC       ((PID_CCP << 8) | 0x70)     /* IPSEC模块 */
...
//zzh add fon MID,2012-03-01.
#define MID_FON			((PID_CCP << 8) | 0x9d)

//liangbingtong add dsl tr069 diag MID , 2012-3-19
#define MID_TR069DIAG			((PID_CCP << 8) | 0x9e)
#define MID_PCP         ((PID_CCP << 8) | 0x9f)     /* PCP 模块 */
...
#else
#define MID_MON     (MID_PC + 1)       /* MON 模块 */
#define MID_LBT     (MID_PC + 2)       /* LBT 模块 */
#endif
...
#define MID_GRP_WAN_CONN_SET_CHNG (((PID_CCP << 8) | MID_GRP_BASE) + 17)
#define MID_GRP_DEFAULT_ROUTE_CHANGE (((PID_CCP << 8) | MID_GRP_BASE) + 18)
//ipv6
#define MID_GRP_IP6CONN_STAT_CHANGED  (((PID_CCP << 8) | MID_GRP_BASE) + 24)
...
enum
{
	...
	MSG_TFGUI_DEVICE_ADD,/*GUI 设备添加删除消息宏*/
    MSG_TFGUI_DEVICE_DEL,
    ...
    MSG_IP6AAC_NOTIFY,
    MSG_IP6AAC_NOTIFY_ADDRTYPE,
    MSG_IP6AAC_REQUEST,
    MSG_IP6AAC_RELEASE,
    MSG_IP6CONN_STAT_CHANGED,
	...
	MSG_WLAN_ENABLE_CHANGE,			//zzh add, using fon.2012-02-25
	MSG_PROUTE_SET_DNS,      //hyh add,use for set dns policy,2012.7.13
	MSG_WLAN_WLANPASSWD,     //shushi add ,use for protest.2012.9.20
	MSG_IGMP_RESTART,
    MSG_PUB_END      = 0x7FFF
...
#define MSG_PROUTE_SET_DNS_ACK                    TBS_MSG_ACK_TYPE(MSG_PROUTE_SET_DNS)
...
#define MSG_WLAN_ENABLE_CHANGE_ACK            TBS_MSG_ACK_TYPE(MSG_WLAN_ENABLE_CHANGE)
...
#define FACTORY_RESET_PATH "InternetGatewayDevice.DeviceInfo.X_TWSZ-COM_FactoryMode"
#define FACTORY_MODE_FILE "/var/factorymode.txt"
