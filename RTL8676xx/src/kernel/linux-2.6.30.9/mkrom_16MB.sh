...
../tools/packimg/genhead  -i vmbin.img -o vm.hdr -k $key -f 0xbfd00000  -a 0x80000000 -e 0x80000000
...
rm vmbin_tmp.img
../tools/packimg/genhead  -i vmbin2.img -o vm2.hdr -k $key -f 0xbfd00000  -a 0x80000000 -e 0x80000000
