...
/*	printk("\n lan_restrict_rcv, dev is %s\n", skb->dev->name);*/
	//if ((memcmp(skb->dev->name, "br0", 3) ==0) || (memcmp(skb->dev->name, "eth0", 4) ==0) && (memcmp(skb->dev->name, "wlan0", 5) ==0))
        ...
        if(if ((memcmp(skb->dev->name, ALIASNAME_BR0, strlen(ALIASNAME_BR0)) ==0) || (memcmp(skb->dev->name, ALIASNAME_ETH0, strlen(ALIASNAME_ETH0)) ==0) )!=  ((memcmp(skb->dev->name, "br0", 3) ==0) || (memcmp(skb->dev->name, "eth0", 4) ==0) )  )
        {
        	  printk("==================\n\n\n\n");
...
#else
    	if ((memcmp(skb->dev->name, ALIASNAME_BR0, strlen(ALIASNAME_BR0)) ==0) || (memcmp(skb->dev->name, ALIASNAME_ETH0, strlen(ALIASNAME_ETH0)) ==0) )    
#endif    	
#else	
	if ((memcmp(skb->dev->name, "br0", 3) ==0) || (memcmp(skb->dev->name, "eth0", 4) ==0) )//
