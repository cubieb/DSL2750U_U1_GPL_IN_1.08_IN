...
//减少TCP连接跟踪的超时时间，防止BT下载连接跟踪很快占满
/*static*/ unsigned int tcp_timeouts[TCP_CONNTRACK_MAX] __read_mostly = {
	[TCP_CONNTRACK_SYN_SENT]	= 5 SECS,
	[TCP_CONNTRACK_SYN_RECV]	= 5 SECS,
	[TCP_CONNTRACK_ESTABLISHED]	= 5 DAYS,
	[TCP_CONNTRACK_FIN_WAIT]	= 10 SECS,
	[TCP_CONNTRACK_CLOSE_WAIT]	= 10 SECS,
	[TCP_CONNTRACK_LAST_ACK]	= 10 SECS,
	[TCP_CONNTRACK_TIME_WAIT]	= 10 SECS,
	[TCP_CONNTRACK_CLOSE]		= 5 SECS,
};
...
#if !defined(CONFIG_RTL867X_IPTABLES_FAST_PATH) && !defined(CONFIG_RTL_HARDWARE_NAT) && !defined(CONFIG_RTL_IPTABLES_FAST_PATH)
		      ...
		      unsigned int hooknum)
{
	...
	case TCP_CONNTRACK_LAST_ACK:
		//printk("====del hw_napt of last_ack: %s(%d)====\n", __FUNCTION__, __LINE__);
	...
	if (!test_bit(IPS_SEEN_REPLY_BIT, &ct->status)) {
		...
		nf_conntrack_event_cache(IPCT_STATUS, ct);
                    ...
                    /* add deal with for tcp derived conntrack here*/
#endif
