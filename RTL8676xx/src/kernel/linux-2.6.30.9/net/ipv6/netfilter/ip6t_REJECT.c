...
reject_tg6(struct sk_buff *skb, const struct xt_target_param *par)
{
	...
	case IP6T_ICMP6_PORT_UNREACH:
		...
		break;
    case IP6T_ICMP6_SADDR_FAILED:
        send_unreach(net, skb, ICMPV6_SADDR_FAILED, par->hooknum);
        break;
    case IP6T_ICMP6_REJECT_ROUTE_DEST:
        send_unreach(net, skb, ICMPV6_REJECT_ROUTE_DEST, par->hooknum);
        break;
