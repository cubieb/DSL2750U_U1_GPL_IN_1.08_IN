...
#if defined(CONFIG_RTL8190_PRIV_SKB) || defined(CONFIG_RTL_ETH_PRIV_SKB) || defined(CONFIG_RTL865X_ETH_PRIV_SKB)
...
#if defined(CONFIG_IMQ) || defined(CONFIG_IMQ_MODULE)
	skb_copy_stored_cb(new, (struct sk_buff *)old);
#endif
...
#define C(x) n->x = skb->x
	...
	C(data);
	C(truesize);
#if defined(CONFIG_BRIDGE_EBT_VLAN_T) || defined(CONFIG_BRIDGE_EBT_VLAN_T_MODULE) || \
	defined(CONFIG_BRIDGE_EBT_TBSVLAN) || defined(CONFIG_BRIDGE_EBT_TBSVLAN_MODULE)
	C(vlan_tci);
#endif
...
#if (defined(CONFIG_RTL_ETH_PRIV_SKB) || defined(CONFIG_RTL865X_ETH_PRIV_SKB)) && (defined(CONFIG_NET_WIRELESS_AGN) || defined(CONFIG_NET_WIRELESS_AG) || defined(CONFIG_WIRELESS))
