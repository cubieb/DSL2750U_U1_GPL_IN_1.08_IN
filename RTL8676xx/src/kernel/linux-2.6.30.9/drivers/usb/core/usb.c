...
static void usb_enable_IP(void)
{
	if (IS_RTL8676) {
...
static int __init usb_init(void)
{
	...
	usbled.b.en_usb_led_0_n = USBLED_ENABLE;
	usbled.b.en_usb_led_1_n = USBLED_ENABLE;
	usbled.b.usb_led_bs_0 = USBLED_BLINK;
	usbled.b.usb_led_bs_1 = USBLED_BLINK;
	usbled.b.usb_speed_sel_0 = USBLED_ALL_SPEED;
	usbled.b.usb_speed_sel_1 = USBLED_ALL_SPEED;
	REG32(USBLED) = usbled.d32;   //cathy, port 0, 1 LED blink for all speed
#endif	//CONFIG_USB_RTL8676_SUPPORT
