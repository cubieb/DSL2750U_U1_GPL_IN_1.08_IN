...
* All rights reserved.
* 
* $Header: /usr/local/dslrepos/linux-2.6.30/drivers/net/rtl819x/AsicDriver/rtl865xc_asicregs.h,v 1.6 2011/09/05 06:49:08 cathy Exp $
*
...
#define MACCR1					(0x058+SWMACCR_BASE)
#endif //CONFIG_RTL_8676HWNAT
#ifdef CONFIG_RTL_8196D
#define PIR0					(0x05C+SWMACCR_BASE)	/* Port Isolation Register 0*/
#define PIR1					(0x060+SWMACCR_BASE)	/* Port Isolation Register 1*/
#define PIR2					(0x064+SWMACCR_BASE)	/* Port Isolation Register 2*/
#endif

#ifdef CONFIG_RTL_8196D
/* Port Isolation register field definitions */
#define PI_PORT0_OFFSET 0
#define PI_PORT0_MASK (0x1ff<<PI_PORT0_OFFSET)
#define PI_PORT1_OFFSET 10
#define PI_PORT1_MASK (0x1ff<<PI_PORT1_OFFSET)
#define PI_PORT2_OFFSET 20
#define PI_PORT2_MASK (0x1ff<<PI_PORT2_OFFSET)

#define PI_PORT3_OFFSET 0
#define PI_PORT3_MASK (0x1ff<<PI_PORT3_OFFSET)
#define PI_PORT4_OFFSET 10
#define PI_PORT4_MASK (0x1ff<<PI_PORT4_OFFSET)
#define PI_PORT5_OFFSET 20
#define PI_PORT5_MASK (0x1ff<<PI_PORT5_OFFSET)
#endif
...
#if defined(CONFIG_RTL_8676HWNAT)
#define EnTxCPUtag							(1<<26)
#define EnCPUtag							(1<<25)
#endif //CONFIG_RTL_8676HWNAT
...
#if defined(CONFIG_RTL_8676HWNAT)
#define RGMII_RCOMP_MASK					(7<<0)					/* RGMII Input Timing compensation control */
#define RGMII_RCOMP_0NS						(0<<0)					/* Rcomp 0.0 ns */
#define RGMII_RCOMP_0DOT5NS					(1<<0)					/* Rcomp 0.5 ns */
#define RGMII_RCOMP_1NS						(2<<0)					/* Rcomp 1.0 ns */
#define RGMII_RCOMP_1DOT5NS					(3<<0)					/* Rcomp 1.5 ns */
#define RGMII_RCOMP_2NS						(4<<0)					/* Rcomp 2.0 ns */
#define RGMII_RCOMP_2DOT5NS					(5<<0)					/* Rcomp 2.5 ns */
#define RGMII_RCOMP_3NS						(6<<0)					/* Rcomp 3.0 ns */
#define RGMII_RCOMP_3DOT5NS					(7<<0)					/* Rcomp 3.5 ns */
#define RGMII_TCOMP_MASK					(1<<4)					/* RGMII Output Timing compensation control */
#define RGMII_TCOMP_0NS						(0<<4)					/* Tcomp 0.0 ns */
#define RGMII_TCOMP_2NS						(1<<4)					/* Tcomp 2.0 ns */
...
#define OUTPUTQUEUE_STAT_MASK_CR1			0x1fffffff
...
#define EN_ETHER_L3_CHKSUM_REC              (1 << 4)    /* Enable L3 checksum recalculation*/
#define EN_ETHER_L4_CHKSUM_REC              (1 << 5)    /* Enable L4 checksum recalculation*/
