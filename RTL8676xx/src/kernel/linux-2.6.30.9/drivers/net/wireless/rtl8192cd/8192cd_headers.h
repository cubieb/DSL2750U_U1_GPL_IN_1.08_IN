 ...
 *
 *  $Id: 8192cd_headers.h,v 1.7 2011/09/08 09:37:15 cathy Exp $
 *
...
//EXTERN void remove_RATid(struct rtl8192cd_priv *priv, struct stat_info *pstat);
...
EXTERN void dig_cca_dm(struct rtl8192cd_priv *priv);
...
EXTERN void set_per_packet_retry_in_txdesc(struct rtl8192cd_priv *priv, unsigned short macid, unsigned char q_num, unsigned char retry_cnt);
...
//EXTERN int issue_tpt_tstpkt(struct rtl8192cd_priv *priv);
EXTERN void amsdu_timeout(struct rtl8192cd_priv *priv, unsigned int current_time);
#ifdef BUFFER_TX_AMPDU
EXTERN void ampdu_timeout(struct rtl8192cd_priv *priv, unsigned int current_time);
#endif
...
EXTERN void psk_indicate_evt(struct rtl8192cd_priv *priv, int id,
...
#ifdef CONFIG_RTL8676
extern void get_wifi_wake_pin(int *gpio_num);
extern void get_wifi_wps_pin(int* gpio_num);
