 ...
 *
 *  $Id: 8192cd_ioctl.c,v 1.11 2011/09/08 09:37:15 cathy Exp $
 *
...
#define MP_QUERY_PSD  		0x8BC7     //czyao
...
#ifdef 	EN_EFUSE
	{ SIOCEFUSE_GET, IW_PRIV_TYPE_CHAR | 128, IW_PRIV_TYPE_CHAR | 128, "efuse_get" },
	{ SIOCEFUSE_SET, IW_PRIV_TYPE_CHAR | 128, IW_PRIV_TYPE_CHAR | 128, "efuse_set" },
...
static struct iwpriv_arg mib_table[] = {
	...
	{"DFS_timeout",	INT_T,		_OFFSET(dot11DFSEntry.DFS_timeout), _SIZE(dot11DFSEntry.DFS_timeout), msecs_to_jiffies(10)},
	{"DFS_detected",INT_T,		_OFFSET(dot11DFSEntry.DFS_detected), _SIZE(dot11DFSEntry.DFS_detected), 0},
	{"NOP_timeout",	INT_T,		_OFFSET(dot11DFSEntry.NOP_timeout), _SIZE(dot11DFSEntry.NOP_timeout), (1805*HZ)},
...
#else
#if defined(CONFIG_RTL8196B_GW_8M) || defined(CONFIG_RTL8196C_AP_ROOT) || defined(CONFIG_RTL8198_AP_ROOT) || defined(CONFIG_RTL8196C_CLIENT_ONLY)
	...
	{"rc_timeout",	INT_T,		_OFFSET(reorderCtrlEntry.ReorderCtrlTimeout), _SIZE(reorderCtrlEntry.ReorderCtrlTimeout), (300*HZ)},//jiffies
	...
	{"rssi_expire_to",	RFFT_T,	_OFFSET_RFFT(rssi_expire_to), _SIZE_RFFT(rssi_expire_to), 60 },//this is time (seconds)
	{"nbi_filter_enable",	RFFT_T,	_OFFSET_RFFT(nbi_filter_enable), _SIZE_RFFT(nbi_filter_enable), 0},
	{"rts_init_rate",	RFFT_T,	_OFFSET_RFFT(rts_init_rate), _SIZE_RFFT(rts_init_rate), 1},
	...
	{"wg_20m_diff_0",	RFFT_T,		_OFFSET_RFFT(wg_20m_diff_0), _SIZE_RFFT(wg_20m_diff_0), 10},
	{"wg_20m_diff_1",	RFFT_T,		_OFFSET_RFFT(wg_20m_diff_1), _SIZE_RFFT(wg_20m_diff_1), 9},
	{"wg_20m_diff_2",	RFFT_T,		_OFFSET_RFFT(wg_20m_diff_2), _SIZE_RFFT(wg_20m_diff_2), 9},
	{"wg_20m_diff_3",	RFFT_T,		_OFFSET_RFFT(wg_20m_diff_3), _SIZE_RFFT(wg_20m_diff_3), 5},
	{"wg_40m_diff_0",	RFFT_T,		_OFFSET_RFFT(wg_40m_diff_0), _SIZE_RFFT(wg_40m_diff_0), 10},
	{"wg_40m_diff_1",	RFFT_T,		_OFFSET_RFFT(wg_40m_diff_1), _SIZE_RFFT(wg_40m_diff_1), 9},
	{"wg_40m_diff_2",	RFFT_T,		_OFFSET_RFFT(wg_40m_diff_2), _SIZE_RFFT(wg_40m_diff_2), 9},
	{"wg_40m_diff_3",	RFFT_T,		_OFFSET_RFFT(wg_40m_diff_3), _SIZE_RFFT(wg_40m_diff_3), 7},
	{"wg_40m_diff_4",	RFFT_T,		_OFFSET_RFFT(wg_40m_diff_4), _SIZE_RFFT(wg_40m_diff_4), 7},
	{"wg_40m_diff_5",	RFFT_T,		_OFFSET_RFFT(wg_40m_diff_5), _SIZE_RFFT(wg_40m_diff_5), 5},	
#endif
...
#ifdef PCIE_POWER_SAVING
	{"ps",		RFFT_T, _OFFSET_RFFT(power_save), _SIZE_RFFT(power_save), (L1_en|_1x1_en|offload_en|stop_dma_en)},
#ifdef WIFI_SIMPLE_CONFIG
	...
	{"txPowerPlus_cck_1",	RFFT_T,	_OFFSET_RFFT(txPowerPlus_cck_1), _SIZE_RFFT(txPowerPlus_cck_1), 0xff},
	{"txPowerPlus_cck_2",	RFFT_T,	_OFFSET_RFFT(txPowerPlus_cck_2), _SIZE_RFFT(txPowerPlus_cck_2), 0xff},
	{"txPowerPlus_cck_5",	RFFT_T,	_OFFSET_RFFT(txPowerPlus_cck_5), _SIZE_RFFT(txPowerPlus_cck_5), 0xff},
	{"txPowerPlus_cck_11",	RFFT_T,	_OFFSET_RFFT(txPowerPlus_cck_11), _SIZE_RFFT(txPowerPlus_cck_11), 0xff},
	...
	{"rts_txtime_enlarge",	RFFT_T,	_OFFSET_RFFT(rts_txtime_enlarge), _SIZE_RFFT(rts_txtime_enlarge), 0},
...
#if (!defined(CONFIG_RTL_COMAPI_CFGFILE) && !defined(CONFIG_RTL_COMAPI_WLTOOLS))
static
#endif
...
static int get_mib(struct rtl8192cd_priv *priv, unsigned char *data)
{
	struct iwpriv_arg *entry;
				...
				)
{
	...
	while ((plist != phead) && (size > 0))
	{
		...
		if ((pstat->state & WIFI_ASOC_STATE) &&
			...
			pInfo->expired_time = pstat->expire_to * 100; // unit:10 ms;
...
#ifdef MICERR_TEST
static int issue_mic_err_pkt(struct rtl8192cd_priv *priv)
{
	struct sk_buff *skb;
...
#ifdef	SUPPORT_TX_MCAST2UNI
static void AddDelMCASTGroup2STA(struct rtl8192cd_priv *priv, unsigned char *mac2addr, int add)
{
...
void drvmac_loopback(struct rtl8192cd_priv *priv)
{
	...
	if (memcmp(da, "\x0\x0\x0\x0\x0\x0", 6) && !IS_MCAST(da))
	{
		...
		if (pstat == NULL)
		{
			...
			pstat->expire_to = 30000;//this is time (seconds)
