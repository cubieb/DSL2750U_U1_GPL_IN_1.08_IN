 ...
 *
 *  $Id: 8192cd.h,v 1.9 2011/09/08 09:37:15 cathy Exp $
 *
...
#endif
	//CLIENT_RESERVED			= 0x10,
	RTK_CAP_IE_WLAN_8192SE	= 0x20,
	RTK_CAP_IE_WLAN_81xxC	= 0x40,
...
//	unsigned char		rxsc_nexthopMAC[MACADDRLEN];
//#endif
	...
	unsigned long		ADDBA_Prev_Time[8];
	unsigned char		ADDBA_ready[8];
	unsigned char		ADDBA_req_num[8];
	unsigned char		ADDBA_declined[8];
...
struct rf_finetune_var {
...
#ifdef WIFI_SIMPLE_CONFIG
	unsigned char		wps_led_active;
	unsigned char		wps_led_state;
#endif
#endif
	...
	unsigned char		txPowerPlus_cck_1;
	unsigned char		txPowerPlus_cck_2;
	unsigned char		txPowerPlus_cck_5;
	unsigned char		txPowerPlus_cck_11;
	...
	unsigned char		rts_txtime_enlarge;

#ifdef CONFIG_RTL_NEW_AUTOCH
	unsigned int		wg_20m_diff_0;	// default 10
	unsigned int		wg_20m_diff_1;	// default 9
	unsigned int		wg_20m_diff_2;	// default 9
	unsigned int		wg_20m_diff_3;	// default 5
	unsigned int		wg_40m_diff_0;	// default 10
	unsigned int		wg_40m_diff_1;	// default 9
	unsigned int		wg_40m_diff_2;	// default 9
	unsigned int		wg_40m_diff_3;	// default 7
	unsigned int		wg_40m_diff_4;	// default 7
	unsigned int		wg_40m_diff_5;	// default 5
#endif
};
...
#define AC_LOG_EXPIRE	(3*HZ)//300	// entry expire time
