 ...
 *
 *	 $Id: 8192c_reg.h,v 1.3 2011/06/09 03:04:16 krammer Exp $
 *
...
#define     GP70IMR             0x058   // GPIO7~0 Interrupt Mask.
#define     GP70ISR             0x05C   // GPIO7~0 Interrupt Status.
...
#define		BIST_RPT			0x0D4  	// BIST Report
...
#define		RFINI_RDY			BIT(5)	// MCU Initial RF ready.
#define		BBINI_RDY			BIT(4)	// MCU Initial BB ready.
#define		MACINI_RDY			BIT(3)	// MCU Initial MAC ready.
...
//----------------------------------------------------------------------------
//       8192C BIST_RPT bits						(Offset 0xD4-D7, 32 bits)
//----------------------------------------------------------------------------
#define		MAC_BIST_FAIL			BIT(31)	// MAC_BIST_FAIL.
#define		USB_IRAM_FAIL			BIT(26)	// USB IRAM BIST FAIL.
#define		USB_RAM1_FAIL			BIT(25)	// USB RAM1 BIST FAIL.
#define		USB_PROM_FAIL			BIT(24)	// USB PROM BIST FAIL.
#define		PCIE_RETRY_BIST_FAIL	BIT(20)	// PCIE RETRY RAM BIST FAIL.
#define		PCIE_SOT_BIST_FAIL		BIT(19)	// PCIE RETRY SOT RAM BIST FAIL.
#define		PCIE_PH1_BIST_FAIL		BIT(18)	// PCIE PHDR RAM1 BIST FAIL.
#define		PCIE_PH0_BIST_FAIL		BIT(17)	// PCIE PHDR RAM0 BIST FAIL.
#define		PCIE_PD_BIST_FAIL		BIT(16)	// PCIE PDATA RAM BIST FAIL.
#define		MAC_BIST_RDY			BIT(10)	// MAC MBIST Test report Ready.
#define		USB_BIST_RDY			BIT(9)	// USB MBIST Test report Ready.
#define		PCIE_BIST_RDY			BIT(8)	// PCIE MBIST Test report Ready.
#define		MAC_BIST_START		BIT(2)	// MAC MBIST START PULSE.
#define		USB_BIST_START		BIT(1)	// USB MBIST START PULSE.
#define		PCIE_BIST_START		BIT(0)	// PCIE MBIST START PULSE.
...
#define		TBTT_HOLD_TIME_Mask			0x0FF
...
//----------------------------------------------------------------------------
//eason patch CHK_KEYID for wep can't access in 802.1x
...
#define		OOB							BIT(1)	// out of band indication (0:in band,1:out of band).
