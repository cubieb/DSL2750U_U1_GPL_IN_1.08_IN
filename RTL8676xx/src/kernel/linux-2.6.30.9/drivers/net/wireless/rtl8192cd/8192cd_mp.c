 ...
 *  MP routines
 *
 *  $Id: 8192cd_mp.c,v 1.13 2011/11/09 12:03:34 eason Exp $
 *
...
//	tx_power_control(priv, NULL, FALSE);
	...
	RTL_W32(0xc30, 0x69e9ac4a);	// To avoid false alarm caused by equipment LO during mp testing.
	RTL_W32(0xc3c, 0x0a979718);	// improve legacy low rate sensitivity in AWGN channel.
