 ...
 *
 *  $Id: 8192cd_security.h,v 1.5 2011/09/08 09:37:15 cathy Exp $
 *
...
#define	MIC_TIMER_PERIOD	(HZ*60)//100*60	//unit: 10 milli-seconds
#define REJECT_ASSOC_PERIOD	(HZ*60)//100*60
