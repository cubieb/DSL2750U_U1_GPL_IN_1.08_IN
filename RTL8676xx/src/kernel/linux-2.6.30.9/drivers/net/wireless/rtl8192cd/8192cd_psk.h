 ...
 *
 *  $Id: 8192cd_psk.h,v 1.2 2010/10/26 09:30:21 yachang Exp $
 *
...
{
 	unsigned char		key_desc_ver __WLAN_ATTRIB_PACK__;
 	unsigned char		key_info[2] __WLAN_ATTRIB_PACK__;
 	unsigned char		key_len[2] __WLAN_ATTRIB_PACK__;
 	unsigned char		key_replay_counter[KEY_RC_LEN] __WLAN_ATTRIB_PACK__;
 	unsigned char		key_nounce[KEY_NONCE_LEN] __WLAN_ATTRIB_PACK__;
 	unsigned char		key_iv[KEY_IV_LEN] __WLAN_ATTRIB_PACK__;
 	unsigned char		key_rsc[KEY_RSC_LEN] __WLAN_ATTRIB_PACK__;
 	unsigned char		key_id[KEY_ID_LEN] __WLAN_ATTRIB_PACK__;
 	unsigned char		key_mic[KEY_MIC_LEN] __WLAN_ATTRIB_PACK__;
 	unsigned char		key_data_len[KEY_MATERIAL_LEN] __WLAN_ATTRIB_PACK__;
 	unsigned char		*key_data __WLAN_ATTRIB_PACK__;
} lib1x_eapol_key;


__PACK struct lib1x_eapol
{
 	unsigned char		protocol_version __WLAN_ATTRIB_PACK__;
 	unsigned char		packet_type __WLAN_ATTRIB_PACK__;			// This makes it odd in number !
 	unsigned short		packet_body_length __WLAN_ATTRIB_PACK__;
};
