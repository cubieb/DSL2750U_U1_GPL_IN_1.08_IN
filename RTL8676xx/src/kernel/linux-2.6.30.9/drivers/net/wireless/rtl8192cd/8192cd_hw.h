 ...
 *
 *  $Id: 8192cd_hw.h,v 1.5 2011/09/08 09:37:15 cathy Exp $
 *
...
#define	HP_UPPER_RA			0x43 //SS = 67%
#define	HP_LOWER_RA			0x3F //SS = 63%
...
// switch BE to VI
	...
	unsigned char				MCSTxAgcOffset_A[16];
	unsigned char				MCSTxAgcOffset_B[16];
	unsigned char				OFDMTxAgcOffset_A[8];
	unsigned char				OFDMTxAgcOffset_B[8];
	unsigned int				CCKTxAgc_A[4];
	unsigned int				CCKTxAgc_B[4];
