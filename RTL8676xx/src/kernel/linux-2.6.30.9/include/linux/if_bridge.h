...
// Kaohj --- wireless bridge blocking
#define BRCTL_SET_WLAN_BLOCKING 19
#define BRCTL_SET_MBSSID_BLOCKING 20
...
#define BRCTL_VLAN_SHOW 31
#define BRCTL_VLAN_SET 32
#endif
