...
#define FIREWALLLOG_MUTEX_NAME                 "FIREWALLLOG_MUTEX"
...
#define COMPAT_IPT_ENTRY_ITERATE_CONTINUE(entries, size, n, fn, args...) \
	...
	#define RTL865X_CHAINLIST_NUMBER_PER_TBL 4
	#endif
	
	#define RTL865x_CHAINLIST_PRIORITY_LEVEL_L2_UNI_PERMIT 	0  /*             permit the pkts  in bridge shortcut                                 */
	#define RTL865x_CHAINLIST_PRIORITY_LEVEL_L3_TRAP 		1  /*             trap the pkts in url/domain filter                                     */
	#ifndef CONFIG_RTL_MULTI_ETH_WAN
	#define RTL865x_CHAINLIST_PRIORITY_LEVEL_L3_PERMIT 		2  /*             permit the pkts  in iptables fastpath                               */
	#else
	#if 0
	#define RTL865x_CHAINLIST_PRIORITY_LEVEL_L2_UNI_REDIRECT	2
	#define RTL865x_CHAINLIST_PRIORITY_LEVEL_L3_REDIRECT	3  /*             redirect pkts to specific interface                                    */
	#define RTL865x_CHAINLIST_PRIORITY_LEVEL_L3_PERMIT 		4  /*             permit the pkts  in iptables fastpath                               */
	#else
	#define RTL865x_CHAINLIST_PRIORITY_LEVEL_L3_REDIRECT	2  /*             redirect pkts to specific interface                                    */
	#define RTL865x_CHAINLIST_PRIORITY_LEVEL_L3_PERMIT 		3  /*             permit the pkts  in iptables fastpath                               */
	#endif
	#endif
#else
