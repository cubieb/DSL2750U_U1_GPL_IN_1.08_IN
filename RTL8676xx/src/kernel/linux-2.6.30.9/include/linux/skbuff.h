...
#if defined(CONFIG_HAS_DMA) && !defined(CONFIG_RTL8676)
...
#if defined(CONFIG_VLAN_MODE) || defined(CONFIG_BRIDGE_EBT_TBSVLAN)
	unsigned short 		vlan;
#endif
...
/*linux-2.6.19*/
#define NET_SKB_PAD	 128 // !!!Do NOT edit!!! yachang. 
#endif
...
void init_skb(struct sk_buff *skb,int allocsize);
void prealloc_skb_init(unsigned int num);
struct sk_buff *prealloc_skb_get(void);
void prealloc_skb_free(struct sk_buff *skb);
#ifdef CONFIG_SKB_POOL_PRIV
struct sk_buff *priv_skb_alloc(unsigned int size);
...
#if (defined(CONFIG_RTL_ETH_PRIV_SKB) || defined(CONFIG_RTL865X_ETH_PRIV_SKB)) && (defined(CONFIG_NET_WIRELESS_AGN) || defined(CONFIG_NET_WIRELESS_AG))
