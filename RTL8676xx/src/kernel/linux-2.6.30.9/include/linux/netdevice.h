...
/*TBS_TAG: call the mirror function of dev add by xiachaoren*/
    ...
    struct net_device  *mirror_dev;   /*pointer to device of mirror*/
    unsigned char      direct_flags;  /*Flags of mirror*/
#endif
...
/*TBS_TAG: call the mirror function of dev add by xiachaoren*/
#if (defined(CONFIG_WAN_MIRROR) || defined(CONFIG_WAN_MIRROR_MODULE))
	void (*mirror_tx)(struct sk_buff *skb, struct net_device *dev, u32 dir);
#endif
/*TBS_TAG_END 2011-11-22*/
...
//#ifdef CONFIG_EXT_SWITCH
	int			vlan;	/* vlan flag (enable/disable) */
	int			vid;
	int			egtag;
//#endif
...
extern int dev_getipaddr(struct net * net, __be32 osipaddr, __be32 rsipaddr);
