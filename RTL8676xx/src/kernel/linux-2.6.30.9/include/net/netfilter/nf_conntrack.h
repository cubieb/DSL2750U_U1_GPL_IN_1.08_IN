...
#else
static inline int alg_enable(int type)
{
    return 1;
}
#define ALG_CHECK_ONOFF(type)
...
#if defined(CONFIG_RTL_NF_CONNTRACK_GARBAGE_NEW)
#define TCP_CONNTRACK_CLOSE_GC_THRESHOLD 60
#define TCP_CONNTRACK_LAST_ACK_GC_THRESHOLD 30
#define TCP_CONNTRACK_CLOSE_WAIT_GC_THRESHOLD 60
#define TCP_CONNTRACK_TIME_WAIT_GC_THRESHOLD 120
#define TCP_CONNTRACK_FIN_WAIT_GC_THRESHOLD 120
#define UDP_UNREPLY_GC_THRESHOLD 30
#define TCP_CONNTRACK_SYN_SENT_GC_THRESHOLD 90
#define TCP_CONNTRACK_SYN_RECV_GC_THRESHOLD 30
#define UDP_ASSURED_GC_THRESHOLD			60
#define TCP_CONNTRACK_ESTABLISHED_GC_THRESHOLD 120
#endif
