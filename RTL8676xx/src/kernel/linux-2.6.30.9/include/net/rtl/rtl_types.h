...
* Abstract :                                                           
* Author :              
* $Id: rtl_types.h,v 1.5 2011/09/30 08:40:34 ikevin362 Exp $
* $Log: rtl_types.h,v $
* Revision 1.5  2011/09/30 08:40:34  ikevin362
* move definition of port mask to rtl865x_netif.h
*
* Revision 1.4  2011/06/09 03:56:30  ikevin362
* remove needless define, for 0412 100M link issue
*
* Revision 1.3  2011/06/02 14:28:49  tylo
* replace CONFIG_RTL819X
*
* Revision 1.2  2011/04/12 02:24:54  tylo
...
#if defined(__linux__)&&defined(__KERNEL__)&&(defined(CONFIG_RTL_819X)||defined(CONFIG_RTL_8676HWNAT))
...
#if defined(__linux__)&&defined(__KERNEL__)&&(defined(CONFIG_RTL_819X)||defined(CONFIG_RTL_8676HWNAT)) && !defined(CONFIG_RTL_8196C)
...
//#define CONFIG_RTL8196C_ETH_IOT         1       //Kevin
