...
//! @ingroup VOIP_CONTROL
M_EXTERN_DRIVER( VOIP_MGR_SLIC_HOOK ); 
...
M_EXTERN_DRIVER( VOIP_MGR_FLUSH_FIFO ); 
...
M_EXTERN_DRIVER( VOIP_MGR_DTMF_INTO_FIFO );
M_EXTERN_DRIVER( VOIP_MGR_HOOK_INTO_FIFO ); 
...
M_EXTERN_DRIVER( VOIP_MGR_DECT_BUTTON_GET );
