...
{
#if defined(CONFIG_RTK_VOIP_DRIVERS_PCM8651) || defined(CONFIG_RTK_VOIP_DRIVERS_PCM8671) || defined(CONFIG_RTK_VOIP_DRIVERS_PCM865xC) ||defined(CONFIG_RTK_VOIP_DRIVERS_PCM8672) || defined(CONFIG_RTK_VOIP_DRIVERS_PCM8972B_FAMILY) || defined(CONFIG_RTK_VOIP_DRIVERS_PCM89xxC)
	__imem_type = &__iram;
