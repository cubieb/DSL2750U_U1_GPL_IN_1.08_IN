...
#define MAX_NB_CHANNELS		( MAX_SESS_NUM + MAX_VOIP_CH_NUM * 4 )	
#define IVR_RESAMPLER_OFFSET	MAX_SESS_NUM
#define PCMRX_RESAMPLER_OFFSET	( IVR_RESAMPLER_OFFSET + 1 * MAX_VOIP_CH_NUM )
#define PCMHDR_RESAMPLER_OFFSET	( IVR_RESAMPLER_OFFSET + 2 * MAX_VOIP_CH_NUM )
#define T38HDR_RESAMPLER_OFFSET	( IVR_RESAMPLER_OFFSET + 3 * MAX_VOIP_CH_NUM )
#else
#define MAX_NB_CHANNELS		MAX_SESS_NUM	// number for channel support for resampler
#endif
