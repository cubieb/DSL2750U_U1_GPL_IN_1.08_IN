...
int32 DSP_CodecRestart(uint32 chid, uint32 sid, RtpPayloadType uPktFormat, uint32 nFramePerPacket, int32 nG723Type, bool bVAD, uint32 nJitterDelay, uint32 nMaxDelay, uint32 nJitterFactor, uint32 G726Packing, uint32 nPcmMode);
