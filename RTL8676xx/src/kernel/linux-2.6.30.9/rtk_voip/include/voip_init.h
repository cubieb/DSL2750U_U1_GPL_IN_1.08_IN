 ...
 *  - voip_initcall_bus()		1
 *  - voip_initcall_snd_setup()	2	<-- setup for snd  
 *  - voip_initcall_snd_fts()	3	fixed timeslot SND, e.g. DECT 
 *  - voip_initcall_snd()		4
 *  - voip_initcall_dsp()		5
 *  - voip_initcall_con()		6
 *  ============================================= (binding ok!)
...
#define voip_initcall_snd_setup(fn)	__define_initcall("98b",fn,98b)
#define voip_initcall_snd_fts(fn)	__define_initcall("98c",fn,98b)
#define voip_initcall_snd(fn)		__define_initcall("98d",fn,98b)
#define voip_initcall_dsp(fn)		__define_initcall("98e",fn,98c)
#define voip_initcall_con(fn)		__define_initcall("98f",fn,98d)
