...
#endif
#if !defined(CONFIG_RTK_VOIP_DRIVERS_PCM865xC) && !defined(CONFIG_RTK_VOIP_DRIVERS_PCM8972B_FAMILY) && !defined (CONFIG_RTK_VOIP_DRIVERS_PCM89xxC) &&!defined (CONFIG_RTK_VOIP_DRIVERS_PCM8672) /* !RTL8952/62 && !RTL8972B/82B && !RTL89xxC */
...
#endif
#ifndef CONFIG_RTK_VOIP_DSP_DEVICE_NR		// CONFIG_RTK_VOIP_ETHERNET_DSP_IS_HOST
#define CONFIG_RTK_VOIP_DSP_DEVICE_NR	0
#endif
#ifndef CONFIG_RTK_VOIP_SLIC_CH_NR_PER_DSP		// CONFIG_RTK_VOIP_ETHERNET_DSP_IS_HOST
#define CONFIG_RTK_VOIP_SLIC_CH_NR_PER_DSP	0
#endif
#ifndef CONFIG_RTK_VOIP_DAA_CH_NR_PER_DSP		// CONFIG_RTK_VOIP_ETHERNET_DSP_IS_HOST
#define CONFIG_RTK_VOIP_DAA_CH_NR_PER_DSP	0
#endif

#if 1	// for backward compatible only 
#define SLIC_CH_NUM		( \
...
#if defined (CONFIG_RTK_VOIP_DRIVERS_PCM8972B_FAMILY) || defined (CONFIG_RTK_VOIP_DRIVERS_PCM8672) || defined (CONFIG_RTK_VOIP_DRIVERS_PCM89xxC)
...
#endif
#define NEW_TONE_ENTRY_ARCH			/* move both local/remote tone outside */

#ifdef CONFIG_RTK_VOIP_ETHERNET_DSP_IS_HOST
#define ETHERNET_DSP_DEBUG_HOST
#endif
#ifdef CONFIG_RTK_VOIP_ETHERNET_DSP_IS_DSP
#define ETHERNET_DSP_DEBUG_DSP
#endif
