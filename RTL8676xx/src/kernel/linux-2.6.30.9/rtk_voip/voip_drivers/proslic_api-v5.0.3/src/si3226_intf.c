...
**
** $Id: si3226_intf.c,v 1.1 2011/03/15 08:13:29 yachang Exp $
**
** SI3226_Intf.c
...
/*
** Function: Si3226_LBCalBroadcast
**
** Description: 
** Obsoleted - LB cannot be run in broadcast
** mode on si3226 device.
**
** Input Parameters: 
** pProslic: pointer to array of PROSLIC channel objects
** size:     number of PROSLIC channel objects   
...
int Si3226_AudioGainSetup(proslicChanType *pProslic, int32 rxgain, int32 txgain, int preset)
{
    ...
    Si3226_dbgSetTXGain(pProslic,txgain,preset,1);
