 ...
 *
 * $Revision: 1.3 $
 * $LastChangedDate: 2010-02-08 11:14:16 -0600 (Mon, 08 Feb 2010) $
 */
...
typedef enum
{
    VP_STATUS_SUCCESS = 0,          /**< Function excecuted successfully */
    VP_STATUS_FAILURE = 1,          /**< Function excecution failed due to
                                     * unspecified reason */
    VP_STATUS_FUNC_NOT_SUPPORTED = 2,/**< Function not supported for the device*/
    VP_STATUS_INVALID_ARG = 3,      /**< One or more arguments to the function
                                     * are invalid. Under this condition no
                                     * command is issued to the VTD */
    VP_STATUS_MAILBOX_BUSY = 4,     /**< Function failed because VCP’s
                                     ...
                                     */
    VP_STATUS_ERR_VTD_CODE = 5,     /**< Mismatch in device type or termination
                                     * type or VP-API compiled code. Returned
                                     * by VpMakeDeviceObject() and
                                     * VpMakeLineObject() */
    VP_STATUS_OPTION_NOT_SUPPORTED = 6,/**< Specified option not supported for the
                                     * device. Used in VpSetOption() and
                                     * VpGetOption(). */
    VP_STATUS_ERR_VERIFY = 7,       /**< The boot load verification process
                                     * indicates that one or more bytes were
                                     * incorrectly loaded. Applicable for VCP
                                     * in function VpBootLoad() */
    VP_STATUS_DEVICE_BUSY = 8,      /* Resources to excecute the requested
                                     * function are not available. */
    VP_STATUS_MAILBOX_EMPTY = 9,    /**< Mailbox is empty; Data was expected by
                                     * the calling function. */
    VP_STATUS_ERR_MAILBOX_DATA = 10,/**< Mailbox data does not match the type of
                                     * data that was expected. */
    VP_STATUS_ERR_HBI = 11,         /**< An error occured due to mistmacth in
                                     * HBI interface definition compared to what
                                     * is being requested. */
    VP_STATUS_ERR_IMAGE = 12,       /**< Error in VCP image */
    VP_STATUS_IN_CRTCL_SECTN = 13,  /**< API is excecuting critical section of
                                     * the code. Hence it cannot support the
                                     * requested service. */
    VP_STATUS_DEV_NOT_INITIALIZED = 14,/**< Device is not initalized. The device
                                     * needs to be initialized before calling
                                     * the function that returned this error. */
    VP_STATUS_ERR_PROFILE = 15,     /**< An error experienced in the profile.
    ...
    VP_STATUS_CUSTOM_TERM_NOT_CFG = 17, /** Indicates a custom termination type has
                                     * been defined but not yet configured */
    VP_STATUS_DEDICATED_PINS = 18,  /* Some general-purpose IO pins are
                                     * controlled automatically according to the
                                     * Line Termination Type, and are thus not
                                     * accessible directly. */
    VP_STATUS_INVALID_LINE = 19,    /** Line doesn't exists */
    VP_STATUS_LINE_NOT_CONFIG = 20, /**< Line has not been configured */
...
typedef enum {
    ...
    VP_QUERY_ID_METER_COUNT,
    VP_QUERY_ID_LOOP_RES,
    VP_NUM_QUERY_IDS,
...
typedef uint16 VpSendSignalType;
#define VP_SENDSIG_MSG_WAIT_PULSE       (0) /**< Apply a Message Waiting Pulse to the Line */
#define VP_SENDSIG_DTMF_DIGIT           (1)
#define VP_SENDSIG_PULSE_DIGIT          (2)
#define VP_SENDSIG_HOOK_FLASH           (3)
#define VP_SENDSIG_FWD_DISCONNECT       (4) /**< Set in 1mS increments */
#define VP_SENDSIG_POLREV_PULSE         (5) /**< Set in 1mS increments */
#define VP_SENDSIG_MOMENTARY_LOOP_OPEN  (6) /**< Applies Momentary Loop Open to FXO
                                             * Port and indicates if parallel phone
                                             * off-hook is present.
                                             */
#define VP_SENDSIG_TIP_OPEN_PULSE       (7) /**< Set in 1mS increments */
...
typedef enum {
    VP_GEN_TIMER_START  = 0x0000,
    VP_GEN_TIMER_CANCEL = 0x0001
} VpGenTimerCtrlType;
...
typedef enum {
    VP_CAL_BFILTER              = 0x0001,
    VP_CAL_APPLY_BFILTER        = 0x0002,
    VP_CAL_MEASURE_BFILTER      = 0x0003,
    VP_CAL_GET_SYSTEM_COEFF     = 0x0004,
    VP_CAL_APPLY_SYSTEM_COEFF   = 0x0005,
...
typedef VpStatusType
(*VpSetProfileFieldFuncPtrType) (
    struct VpDevCtxType *pDevCtx,
    VpProfilePtrType pProfile,
    VpProfileFieldType *pField);

typedef VpStatusType
(*VpGetProfileFieldFuncPtrType) (
    struct VpDevCtxType *pDevCtx,
    VpProfilePtrType pProfile,
    VpProfileFieldType *pField);
...
typedef struct {
    ...
    VpGetProfileFieldFuncPtrType GetProfileField;
    VpSetProfileFieldFuncPtrType SetProfileField;
