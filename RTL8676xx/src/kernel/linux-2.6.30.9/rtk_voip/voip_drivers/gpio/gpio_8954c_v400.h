...
#define PIN_CS2			GPIO_ID(GPIO_PORT_E,6)	//output 
#define PIN_CS3			GPIO_ID(GPIO_PORT_E,5)	//output 
#define PIN_CS4			GPIO_ID(GPIO_PORT_E,4)	//output 
...
/* LED */ 
#if 0 /* V400 use below GPIO as SLIC CS */
...
#else
#define PIN_VOIP0_LED	GPIO_ID(GPIO_PORT_E,4)    	//undefined
#define PIN_VOIP1_LED	GPIO_ID(GPIO_PORT_E,5)    	//undefined
#define PIN_VOIP2_LED	GPIO_ID(GPIO_PORT_E,6)    	//undefined
#endif
