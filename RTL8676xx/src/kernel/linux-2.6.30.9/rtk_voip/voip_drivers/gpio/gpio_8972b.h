...
#define GPIO "E"
/* SLIC used */
#ifdef CONFIG_RTK_VOIP_DRIVERS_SLIC_ZARLINK	// for RTL89116 SLIC card
...
#define PIN_DECT_PAGE		GPIO_ID(GPIO_PORT_D,2) 	//input
#ifdef CONFIG_RTK_VOIP_DECT_SPI_SUPPORT
#define PIN_DECT_CS1		GPIO_ID(GPIO_PORT_D,3)	//output
#define PIN_DECT_CLK		GPIO_ID(GPIO_PORT_D,4)	//output
#define PIN_DECT_DI		GPIO_ID(GPIO_PORT_D,5) 	//input
#define PIN_DECT_DO		GPIO_ID(GPIO_PORT_D,6) 	//output
#define PIN_DECT_INT		GPIO_ID(GPIO_PORT_D,7) 	//input
#endif
#else
#define PIN_RESET1		GPIO_ID(GPIO_PORT_E,0)	//output
#define PIN_CS1			GPIO_ID(GPIO_PORT_E,1)	//output
