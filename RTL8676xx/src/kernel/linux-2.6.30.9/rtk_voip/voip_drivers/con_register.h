...
// snd_*, bus_* and dsp_* include this files
...
typedef struct {		// FXS - ops  
	...
	void ( *Set_SLIC_Tx_Gain )( struct voip_snd_s *this, unsigned char tx_gain );
	void ( *Set_SLIC_Rx_Gain )( struct voip_snd_s *this, unsigned char rx_gain );
