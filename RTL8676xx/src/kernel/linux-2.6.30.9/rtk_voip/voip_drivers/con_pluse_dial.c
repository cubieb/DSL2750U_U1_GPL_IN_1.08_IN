...
static char pulse_dial_wp[CON_CH_NUM]={0},pulse_dial_rp[CON_CH_NUM]={0};
...
/*************** For Pulse Dial generation ***************/
static int interdigit_time[VOIP_CH_NUM] = {0};
static int pulse_make_time[VOIP_CH_NUM] = {0};
static int pulse_break_time[VOIP_CH_NUM] = {0};
static int pulse_gen_start[VOIP_CH_NUM] = {0};
static int pulse_ONH[VOIP_CH_NUM] = {0}, pulse_OFH[VOIP_CH_NUM] = {0};
static char pulse_event[VOIP_CH_NUM] = {0}, pulse_count[VOIP_CH_NUM] = {0};
...
#ifdef CONFIG_RTK_VOIP_PULSE_DIAL_GEN_TIMER
#if defined (CONFIG_RTK_VOIP_DRIVERS_PCM865xC) || defined (CONFIG_RTK_VOIP_DRIVERS_PCM8972B_FAMILY) || defined(CONFIG_RTK_VOIP_DRIVERS_PCM89xxC)
static __init void timer1_init( void )
{
	int result;
