...
**
** $Id: vdaa.c,v 1.1 2011/03/15 08:13:30 yachang Exp $
**
** Vdaa.c
...
int Vdaa_PCMSetup (vdaaChanType *pVdaa,int32 preset, int32 pcm_enable){ //[THLin change]
	uInt8 regTemp = 0;
	...
	regTemp |= pcm_enable << 5; //[THLin change]
