...
#define CHAN_PER_DEVICE_3217X 1
#ifdef CONFIG_RTK_VOIP_MULTIPLE_SI32178
#define NUM_OF_DAA_3217X	SLIC_CH_NUM
//#define DAA_CHANNEL_OFFSET	SLIC_CH_NUM
#elif defined (CONFIG_RTK_VOIP_SLIC_SI32176_SI32178_CS)
#define NUM_OF_DAA_3217X 1		/* It MUST be one!! */
//#define DAA_CHANNEL_OFFSET	SLIC_CH_NUM
#else
#define NUM_OF_DAA_3217X 1
//#define DAA_CHANNEL_OFFSET 1
#endif
//#elif defined (CONFIG_RTK_VOIP_DRIVERS_SLIC_SI3226)
//#define CHAN_PER_DEVICE_SI3217X 2
//#endif

//#if defined (CONFIG_RTK_VOIP_DRIVERS_SLIC_SI3226) || defined( CONFIG_RTK_VOIP_DRIVERS_SLIC_SI3217x )
#define NUMBER_OF_CHAN_3217X SLIC_CH_NUM
#define NUMBER_OF_PROSLIC_3217X (NUMBER_OF_CHAN_3217X/CHAN_PER_DEVICE_3217X)
#if NUMBER_OF_PROSLIC_3217X < 1
#define NUMBER_OF_PROSLIC_3217X 1
#endif

#define TOTAL_NUM_OF_CH_3217X		( NUM_OF_DAA_3217X + NUMBER_OF_CHAN_3217X )

#if defined( CONFIG_RTK_VOIP_MULTIPLE_SI32178 ) || \
	defined( CONFIG_RTK_VOIP_SLIC_SI32176_SI32178_CS )
#define NUMBER_OF_HWINTF_3217X	NUMBER_OF_PROSLIC_3217X
#else
#define NUMBER_OF_HWINTF_3217X	1
#endif
//#endif
#endif
