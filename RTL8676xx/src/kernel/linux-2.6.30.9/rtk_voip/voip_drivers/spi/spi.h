...
struct rtl_spi_dev_s
{
	...
	uint32 gpioINT;
#endif
#if defined(CONFIG_RTK_VOIP_DRIVERS_SLIC_ZARLINK) && defined(CONFIG_RTK_VOIP_8672_SHARED_SPI)
	uint32 SPI_SEL_CS;
#endif
...
#if defined (CONFIG_RTK_VOIP_DRIVERS_PCM8672) && defined (CONFIG_RTK_VOIP_8672_SHARED_SPI)
