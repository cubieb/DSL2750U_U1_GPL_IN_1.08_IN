...
#define BSP_RGMII_PAD_CTRL		(BSP_MISC_CR_BASE + 0x2C)
	#define BSP_USBLED_GPIO_SEL     (1 << 30)
...
/* Port E,F,G,H */
#define GPIO_PEFGH_CNR		(GPIOCR_BASE+0x1C)	/*Port E,F,G,H control register*/
#define GPIO_PEFGH_PTYPE	(GPIOCR_BASE+0x20)	/*Port E,F,G,H peripheral type control register*/
...
#define PCIE0_MDIO (BSP_PCIE0_H_EXT+0x00)
//MDIO
...
#define RTL8192CD_GPIO_MUXCFG       (BSP_PCIE0_D_MEM + 0x040)//8192C GPIO_MUXCFG bits
//b[31:24]=GPIO_MOD[7:0], b[23:16]=GPIO_IO_SEL[7:0], b[15:8]=GPIO_OUT[]7:0], b[7:0]=GPIO_IN[7:0]
#define RTL8192CD_GPIO_PIN_CTRL		(BSP_PCIE0_D_MEM + 0x044)// GPIO[7:0] PIN Control.
	#define RTL8192CD_GPIO_IN_OFFSET		0
	#define RTL8192CD_GPIO_OUT_OFFSET		8
	#define RTL8192CD_GPIO_IO_SEL_OFFSET	16
	#define RTL8192CD_GPIO_CNR_OFFSET       24
#define RTL8192CD_GPIO_INTM        	(BSP_PCIE0_D_MEM + 0x048)// GPIO Interrupt Monitor Register.	
#define RTL8192CD_GPIO_LEDCFG       (BSP_PCIE0_D_MEM + 0x04C)// System PINMUX Configuration.
#define RTL8192CD_GPIO_FSIMR        (BSP_PCIE0_D_MEM + 0x050)// Firmware System Interrupt Mask.
#define RTL8192CD_GPIO_FSISR        (BSP_PCIE0_D_MEM + 0x054)// Firmware System Interrupt Status.
#define RTL8192CD_GPIO_GP70IMR      (BSP_PCIE0_D_MEM + 0x058)// GPIO7~0 Interrupt Mask.
#define RTL8192CD_GPIO_GP70ISR        (BSP_PCIE0_D_MEM + 0x05C)// GPIO7~0 Interrupt Status.
    #define RTL8192CD_GPIO_ISR_OFFSET       12
#define RTL8192CD_GPIO_HIMR         (BSP_PCIE0_D_MEM + 0x120)// Host Interrupt Mask.
#define RTL8192CD_GPIO_HISR         (BSP_PCIE0_D_MEM + 0x124)// Host Interrupt Status.
#define RTL8192CD_GPIO_HIMRE        (BSP_PCIE0_D_MEM + 0x128)// Host Interrupt Mask Extension.
#define RTL8192CD_GPIO_HISRE        (BSP_PCIE0_D_MEM + 0x12C)// Host Interrupt Status Extension.
#define WPS_BUTTON_GPIO             RTL8192CD_GPIO_2
