...
#define GPIO_IRQ_EDGE_DISABLE	0x00	/* IRQ disabled */
#define GPIO_IRQ_EDGE_FALL 	    0x01	/* falling edge IRQ */
#define GPIO_IRQ_EDGE_RISE 	    0x02	/* rising edge IRQ */
#define GPIO_IRQ_EDGE_BOTH 	    0x03	/* both falling or rising edge IRQ */
...
extern void gpioConfigIntr(int gpio_num, int mode);
extern int gpioGetIntrStatus(int gpio_num);
extern void rtl8676_gpio_set(int gpio_num, int mode);
