...
typedef enum DSL_Autoboot_State
{
   ...
   DSL_AUTOBOOTSTATE_LINK_ACTIVATE_WAIT = 11
 ...
 */
#ifndef SWIG
DSL_uint32_t DSL_AutobootThreadStart
(
 ...
 */
#ifndef SWIG
DSL_uint32_t DSL_AutobootThreadStop
(
   DSL_Context_t *pContext
);
#endif
...
DSL_uint32_t DSL_AutobootThreadRestart
(
   DSL_Context_t *pContext
);
...
#ifndef SWIG
DSL_Error_t DSL_AutobootStateSet(
   DSL_Context_t *pContext,
...
DSL_uint32_t DSL_AutobootStateCheck
(
   DSL_Context_t *pContext
);
