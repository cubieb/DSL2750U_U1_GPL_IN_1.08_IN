...
*/
#define DSL_DBG_MAX_LEVEL DSL_DBG_MSG
...
#define  DSL_DBG_PRINTF (void) DSL_debug_printf
...
*/
DSL_void_t DSL_ErrorSet(DSL_void_t *pContext, DSL_Error_t code);
   ...
   /**
       Set the nErrno value of the context.
   */
   #define DSL_DEBUG_SET_ERROR(code) DSL_ErrorSet(pContext, code)
...
{ \
   ...
   { \
      ...
      DSL_DBG_PRINTF(DSL_NULL, ":Line %i:" DSL_CRLF,__LINE__); \
      DSL_DBG_PRINTF body; \
   } \
}
...
{ \
   ...
   { \
      ...
      DSL_DBG_PRINTF_FUNCTION; \
      DSL_DBG_PRINTF(DSL_NULL, ":Line %i:" DSL_CRLF,__LINE__); \
      DSL_DBG_PRINTF(DSL_NULL, "Assertion failed." DSL_CRLF ); \
      while(1) ; \
   } \
}
