   ...
   <xsl:template match="/">
      <xsl:element name="Document">
         ...
         <xsl:element name="Chapter">
            ...
            <xsl:element name="Title">Web Interface - Data Types and Structure Reference</xsl:element>
...
-->
   ...
   <xsl:template match="detaileddescription">
      ...
      <xsl:if test="string-length($DESCRIPTION_NORM)">
         ...
         <!--TD <xsl:for-each select="para/simplesect[@kind=&apos;remark&apos; or @kind=&apos;note&apos; or @kind=&apos;attention&apos;]/para"> -->
         <xsl:for-each select="para/simplesect[@kind=&apos;note&apos; or @kind=&apos;attention&apos;]/para">
            <Comments>
               <Comment>
                  <xsl:apply-templates select="."/>
               </Comment>
   ...
   <xsl:template name="generate_code_remark">
      ...
      <xsl:variable name="DESCRIPTION_NORM" select="normalize-space($DESCRIPTION_LONG)"/>
         ...
         <xsl:for-each select="detaileddescription/para/simplesect[@kind=&apos;remark&apos; or @kind=&apos;note&apos; or @kind=&apos;attention&apos;]">
            <xsl:element name="SW_Block">
