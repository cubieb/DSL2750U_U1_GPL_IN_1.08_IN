...
if [ "$ARCH" == "mips" ]; then
    ...
    CONF_DRV_CFLAGS="-D__KERNEL__ -Wall -Wstrict-prototypes -Wno-trigraphs -O2\
 -fno-strict-aliasing -fno-common  -fomit-frame-pointer -G 0 -mno-abicalls\
 -fno-pic -pipe  -finline-limit=100000 -mabi=32 -march=mips32 -Wa,-32\
 -Wa,-march=mips32 -Wa,-mips32 -Wa,--trap   -nostdinc -iwithprefix include -DMODVERSIONS" 
fi
...
if [ "$DRIVER_INCLUDE" = "" ]
then
    CONF_DRIVER_INCLUDE="--enable-driver-include="-I$KERNEL_INCLUDE
fi
