...
!insertmacro MUI_LANGUAGEFILE_BEGIN "English"
  ...
  !define MUI_LANGNAME "EnglishIfx" ;Use only ASCII characters (if this is not possible, use the English name)
  
  !define MUI_TEXT_WELCOME_INFO_TITLE "Welcome to the $(^NameDA) Setup"
  ...
  !define MUI_TEXT_LICENSE_SUBTITLE "Please read the following license terms."
  ...
  !define MUI_TEXT_FINISH_INFO_TITLE "Completing the $(^NameDA) Setup"
  ...
  !define MUI_UNTEXT_WELCOME_INFO_TITLE "Welcome to the $(^NameDA) Uninstall"
  ...
  !define MUI_UNTEXT_LICENSE_SUBTITLE "Please read the following license terms."
  ...
  !define MUI_UNTEXT_FINISH_INFO_TITLE "Completing the $(^NameDA) Uninstall"
