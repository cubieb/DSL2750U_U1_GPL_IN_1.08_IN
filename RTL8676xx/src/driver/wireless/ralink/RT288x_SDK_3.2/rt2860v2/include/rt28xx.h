...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(2,6,18)
#define RT2860_CSR_ADDR RALINK_11N_MAC_BASE
#else
...
/*
 *	Application name for Wifi WPS / WSC single trigger notification.
 *
 *  WiFi driver would send a signal "SIGXFSZ" to user define application
 *  while WPS is beginning, so that the application can start up WPS procedure.
 *  Please modify it by your UI applicaion name.
 *  You may reference our sample code.in goahead wps.c WPSSingleTriggerHandler().
 */
