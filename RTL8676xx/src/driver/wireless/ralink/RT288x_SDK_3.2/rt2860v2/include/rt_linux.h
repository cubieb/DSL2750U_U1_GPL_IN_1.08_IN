...
#define AP_DRIVER_VERSION			"1.2.0.0"
#ifdef MULTIPLE_CARD_SUPPORT
...
struct os_cookie {
	...
	struct tasklet_struct	uapsd_eosp_sent_task;
...
#define _RTMP_IO_READ32(_R, _pV)								\
{																\
	(*_pV = readl((void *)(_R)));					\
}

#define _RTMP_IO_WRITE32(_R, _V)												\
{																				\
	UINT	Val;																\
	writel(_V, (void *)(_R));								\
}
