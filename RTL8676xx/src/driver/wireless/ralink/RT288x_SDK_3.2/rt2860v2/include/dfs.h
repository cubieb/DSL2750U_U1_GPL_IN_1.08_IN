...
INT Set_CarrierCriteria_Proc(IN PRTMP_ADAPTER pAd, IN PUCHAR arg);
int Set_CarrierReCheck_Proc(IN PRTMP_ADAPTER pAd, IN PUCHAR arg);
INT Set_CarrierStopCheck_Proc(IN PRTMP_ADAPTER pAd, IN PUCHAR arg);
#endif
