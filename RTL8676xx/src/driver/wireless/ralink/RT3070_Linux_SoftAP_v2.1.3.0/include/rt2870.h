...
{	\
	...
	{USB_DEVICE(0x0DF6,0x0040)}, /* Sitecom 3071*/	\
	...
	{USB_DEVICE(0x1B75,0x3072)}, /* Abocom 3070 */	\
	...
	{USB_DEVICE(0x100D,0x9032)}, /* Motorola 2770 */	\
...
#define RT28XX_AP_UPDATE_CAPABILITY_AND_ERPIE(pAd)	\
 	RTUSBEnqueueInternalCmd(pAd, CMDTHREAD_AP_UPDATE_CAPABILITY_AND_ERPIE, NULL, 0);
...
#ifdef CONFIG_AP_SUPPORT
#define CMDTHREAD_AP_UPDATE_CAPABILITY_AND_ERPIE	0x0D790104	// cmd
#endif // CONFIG_AP_SUPPORT //
// end johnli
