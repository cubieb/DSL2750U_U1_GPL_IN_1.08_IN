...
#ifdef MESH_SUPPORT
	STATE_MACHINE_EX		MeshCtrlMachine;
	STATE_MACHINE_EX		MeshLinkMngMachine;

	STATE_MACHINE_FUNC_EX  MeshCtrlFunc[MESH_CTRL_FUNC_SIZE];
	STATE_MACHINE_FUNC_EX  MeshLinkMngFunc[MESH_LINK_MNG_FUNC_SIZE];
#endif // MESH_SUPPORT //
...
typedef struct _COMMON_CONFIG {
	...
	RALINK_TIMER_STRUCT		QuickResponeForRateUpTimerEx;
	BOOLEAN					QuickResponeForRateUpTimerRunningEx;
...
#ifdef IKANOS_VX_1X0
	struct IKANOS_TX_INFO	IkanosTxInfo[MAX_MBSSID_NUM];
#endif // IKANOS_VX_1X0 //
...
#ifdef CONFIG_AP_SUPPORT
NDIS_STATUS RTMPAPQueryInformation(
	IN  NDIS_HANDLE MiniportAdapterContext,
	IN  NDIS_OID    Oid,
	IN  PVOID       pInformationBuffer,
	IN  ULONG       InformationBufferLength,
...
#ifdef CONFIG_AP_SUPPORT
NDIS_STATUS RTMPAPSetInformation(
	IN  NDIS_HANDLE	MiniportAdapterContext,
	IN  NDIS_OID		Oid,
	IN  PVOID			pInformationBuffer,
	IN  ULONG		InformationBufferLength,
