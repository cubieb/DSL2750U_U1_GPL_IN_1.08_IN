...
#define REG_WRITE(_reg,_val)		*((volatile a_uint32_t *)(_reg)) = (_val);
#define REG_READ(_reg)		*((volatile a_uint32_t *)(_reg))
...
static adf_os_inline void bus_dma_sync_single(void *hwdev,
				dma_addr_t dma_handle,
				size_t size, a_int32_t direction)
{
    unsigned long addr;
...
static adf_os_inline dma_addr_t bus_map_single(void *hwdev, void *ptr,
								 size_t size, a_int32_t direction)
{
...
static adf_os_inline void bus_unmap_single(void *hwdev, dma_addr_t dma_addr,
			     size_t size, a_int32_t direction)
{
...
#define sysRegRead(phys)      (*(volatile a_uint32_t *)phys)
