 ...
 * All rights reserved.
 *
 * $Id: //depot/sw/carriersrc/branches/magpie_host_dev/split_src/host/hal/main/ar5212/ar5212reg.h#3 $
 */
...
/* For Condor only */
#define AR_PCIE_PMC                     0x4068 /* PCIe power management configuration and status register */
#define AR_PCIE_PMC_ENABLE_L1           0x01   /* enable PCIe core enter L1 when d2_sleep_en is asserted */
#define AR_PCIE_PMC_CLR_L0_LOS          0x02   /* clear both L0 and L0S counter registers, this bit is self cleared */
#define AR_PCIE_PMC_EN_L0_LOS           0x04   /* enable both L0 and L0S counters to start counting */ 
#define AR_PCIE_PMC_EN_RESET            0x08   /* enable reset caused by link going down */
...
#define AR_PCICFG_ENABLE_RETRYFIX       0x00001000 /* Enable PCI core retry fix in sw */
#define AR_PCICFG_ENABLE_RETRYFIX_S     12         /* Enable PCI core retry fix in sw: bit 12 */
...
#define AR_USEC_32M         0x00003F80
#define AR_USEC_32M_S       7
...
#define	AR_RAD2111_SREV_MAJOR	0x20	/* All current supported ar5211 2 GHz
					   radios are rev 0x10 */
#define	AR_RAD5112_SREV_MAJOR	0x30	/* 5212 Major Rev */
#define	AR_RAD2112_SREV_MAJOR	0x40	/* 2413 Major Rev */
...
#define AR_RAD5112_SREV_2_1     0x36    /* AR5112 Revision 2.0 */
#define AR_RAD2112_SREV_2_1     0x46    /* AR2112 Revision 2.0 */
...
#define	AR_XRMODE_XR_POLL_TYPE	0x00000003 /* poll type mask */
#define	AR_XRMODE_XR_POLL_TYPE_S	0
#define	AR_XRMODE_XR_POLL_SUBTYPE	0x0000003c /* poll subtype mask */
#define	AR_XRMODE_XR_POLL_SUBTYPE_S	2
#define	AR_XRMODE_XR_WAIT_FOR_POLL	0x00000080 /* wait for poll, sta only */
#define	AR_XRMODE_XR_SIFS_DELAY	0x000fff00 /* cycles delay from cts, xr_poll */
#define	AR_XRMODE_XR_FRAME_HOLD	0xfff00000 /* cycles hold for chirps */
#define	AR_XRMODE_XR_FRAME_HOLD_S	20

#define	AR_XRDEL_SLOT_DELAY	0x0000ffff /* cycles */
#define	AR_XRDEL_SLOT_DELAY_S	0
#define	AR_XRDEL_CHIRP_DATA_DELAY	0xffff0000 /* cycles */
#define	AR_XRDEL_CHIRP_DATA_DELAY_S	16

#define	AR_XRTO_CHIRP_TO	0x0000ffff /* cycles */
#define	AR_XRTO_CHIRP_TO_S	0
#define	AR_XRTO_POLL_TO		0xffff0000 /* cycles */
#define	AR_XRTO_POLL_TO_S	16

#define	AR_XRCRP_SEND_CHIRP	0x00000001 /* generate stand alone chirp */
#define	AR_XRCRP_CHIRP_GAP	0xffff0000 /* cycles */
#define	AR_XRCRP_CHIRP_GAP_S	16 

#define	AR_XRSTMP_TX_STOMP	0x00000001 /* transmit stomp on receive cmd */
#define	AR_XRSTMP_RX_ABORT	0x00000002 /* stomp current receive enable */
#define	AR_XRSTMP_RSSI_THRESH	0x0000ff00 /* threshold for tx stomp */
