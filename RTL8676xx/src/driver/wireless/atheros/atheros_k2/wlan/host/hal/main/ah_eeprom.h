 ...
 * All rights reserved.
 *
 * $Id: //depot/sw/carriersrc/branches/magpie_host_dev/split_src/host/hal/main/ah_eeprom.h#6 $
 */
...
#define EEPROM_PROTECT_OFFSET_PCIE  0x01    /* EEPROM Protect Bits for Condor and Swan */
...
typedef struct fullPcdacStruct {
    a_uint16_t   channelValue;
    a_uint16_t   pcdacMin;
    a_uint16_t   pcdacMax;
    a_uint16_t   numPcdacValues;
    a_uint16_t   PcdacValues[64];
    /* power is 32bit since in dest it is scaled */
    a_int16_t     PwrValues[64];
} FULL_PCDAC_STRUCT;
...
typedef struct {
    a_uint16_t   xpd_gain;
    a_uint16_t   numPcdacs;
    a_uint16_t   pcdac[NUM_POINTS_XPD0];
    a_int16_t     pwr_t4[NUM_POINTS_XPD0];    /* or gainF */
} EXPN_DATA_PER_XPD_5112;

typedef struct {
    a_uint16_t   channelValue;
    a_int16_t     maxPower_t4;
    EXPN_DATA_PER_XPD_5112  pDataPerXPD[NUM_XPD_PER_CHANNEL];
} EXPN_DATA_PER_CHANNEL_5112;

typedef struct {
    a_uint16_t   *pChannels;
    a_uint16_t   numChannels;
    a_uint16_t   xpdMask;    /* mask of permitted xpd_gains */
...
typedef struct {
    ...
    a_uint16_t   pcd1_xg0;
    a_int16_t     pwr1_xg0;
    a_uint16_t   pcd2_delta_xg0;
    a_int16_t     pwr2_xg0;
    a_uint16_t   pcd3_delta_xg0;
    a_int16_t     pwr3_xg0;
    a_uint16_t   pcd4_delta_xg0;
    a_int16_t     pwr4_xg0;
    a_int16_t     maxPower_t4;
    a_int16_t     pwr1_xg3;   /* pcdac = 20 */
    a_int16_t     pwr2_xg3;   /* pcdac = 35 */
    a_int16_t     pwr3_xg3;   /* pcdac = 63 */
    /* XXX - Should be pwr1_xg2, etc to agree with documentation */
} EEPROM_DATA_PER_CHANNEL_5112;

typedef struct {
    a_uint16_t   pChannels[NUM_11A_EEPROM_CHANNELS];
    a_uint16_t   numChannels;
    a_uint16_t   xpdMask;    /* mask of permitted xpd_gains */
...
typedef struct {
    a_uint16_t   pd_gain;
    a_uint16_t   numVpd;
    a_uint16_t   Vpd[NUM_POINTS_LAST_PDGAIN];
    a_int16_t     pwr_t4[NUM_POINTS_LAST_PDGAIN]; /* or gainF */
} RAW_DATA_PER_PDGAIN_2413;

typedef struct {
    a_uint16_t   channelValue;
    a_int16_t     maxPower_t4;
    a_uint16_t   numPdGains; /* # Pd Gains per channel */
...
typedef struct {
    a_uint16_t   pChannels[NUM_11A_EEPROM_CHANNELS_2413];
    a_uint16_t   numChannels;
    a_uint16_t   xpd_mask;   /* mask of permitted xpd_gains */
    RAW_DATA_PER_CHANNEL_2413 pDataPerChannel[NUM_11A_EEPROM_CHANNELS_2413];
} RAW_DATA_STRUCT_2413;

typedef struct {
    a_uint16_t   channelValue;
    a_uint16_t   numPdGains;
    a_uint16_t   Vpd_I[MAX_NUM_PDGAINS_PER_CHANNEL];
    a_int16_t     pwr_I[MAX_NUM_PDGAINS_PER_CHANNEL];
    a_uint16_t   Vpd_delta[NUM_POINTS_LAST_PDGAIN]
                [MAX_NUM_PDGAINS_PER_CHANNEL];
    a_int16_t     pwr_delta_t2[NUM_POINTS_LAST_PDGAIN]
                [MAX_NUM_PDGAINS_PER_CHANNEL];
    a_int16_t     maxPower_t4;
 ...
 */
typedef struct {
    a_uint16_t   ee_version;     /* Version field */
    a_uint16_t   ee_protect;     /* EEPROM protect field */
    a_uint16_t   ee_regdomain;       /* Regulatory domain */

    /* General Device Parameters */
    a_uint16_t   ee_turbo5Disable;
    a_uint16_t   ee_turbo2Disable;
    a_uint16_t   ee_rfKill;
    a_uint16_t   ee_deviceType;
    a_uint16_t   ee_turbo2WMaxPower5;
    a_uint16_t   ee_turbo2WMaxPower2;
    a_uint16_t   ee_xrTargetPower5;
    a_uint16_t   ee_xrTargetPower2;
    a_uint16_t   ee_Amode;
    a_uint16_t   ee_regCap;
    a_uint16_t   ee_Bmode;
    a_uint16_t   ee_Gmode;
    a_int8_t      ee_antennaGainMax[2];
    a_uint16_t   ee_xtnd5GSupport;
    a_uint8_t    ee_cckOfdmPwrDelta;
    a_uint8_t    ee_exist32kHzCrystal;
    a_uint16_t   ee_targetPowersStart;
    a_uint16_t   ee_fixedBias5;
    a_uint16_t   ee_fixedBias2;
    a_uint16_t   ee_cckOfdmGainDelta;
    a_uint16_t   ee_scaledCh14FilterCckDelta;
    a_uint16_t   ee_eepMap;
    a_uint16_t   ee_earStart;

    /* 5 GHz / 2.4 GHz CKK / 2.4 GHz OFDM common parameters */
    a_uint16_t   ee_switchSettling[3];
    a_uint16_t   ee_txrxAtten[3];
    a_uint16_t   ee_txEndToXLNAOn[3];
    a_uint16_t   ee_thresh62[3];
    a_uint16_t   ee_txEndToXPAOff[3];
    a_uint16_t   ee_txFrameToXPAOn[3];
    a_int8_t      ee_adcDesiredSize[3];    /* 8-bit signed value */
    a_int8_t      ee_pgaDesiredSize[3];    /* 8-bit signed value */
    a_int16_t     ee_noiseFloorThresh[3];
    a_uint16_t   ee_xlnaGain[3];
    a_uint16_t   ee_xgain[3];
    a_uint16_t   ee_xpd[3];
    a_uint16_t   ee_antennaControl[11][3];
    a_uint16_t   ee_falseDetectBackoff[3];
    a_uint16_t   ee_gainI[3];
    a_uint16_t   ee_rxtxMargin[3];

    /* new parameters added for the AR2413 */
    HAL_BOOL    ee_disableXr5;
    HAL_BOOL    ee_disableXr2;
    a_uint16_t   ee_eepMap2PowerCalStart;
    a_uint16_t   ee_capField;

    a_uint16_t   ee_switchSettlingTurbo[2];
    a_uint16_t   ee_txrxAttenTurbo[2];
    a_int8_t      ee_adcDesiredSizeTurbo[2];
    a_int8_t      ee_pgaDesiredSizeTurbo[2];
    a_uint16_t   ee_rxtxMarginTurbo[2];
    ...
    /* 2.4 GHz parameters */
    a_uint16_t   ee_obFor24;
    a_uint16_t   ee_dbFor24;
    a_uint16_t   ee_obFor24g;
    a_uint16_t   ee_dbFor24g;
    a_uint16_t   ee_ob2GHz[2];
    a_uint16_t   ee_db2GHz[2];
    a_uint16_t   ee_numCtls;
    a_uint16_t   ee_ctl[32];
    a_uint16_t   ee_iqCalI[2];
    a_uint16_t   ee_iqCalQ[2];
    a_uint16_t   ee_calPier11g[NUM_2_4_EEPROM_CHANNELS];
    a_uint16_t   ee_calPier11b[NUM_2_4_EEPROM_CHANNELS];

    /* corner calibration information */
    CORNER_CAL_INFO ee_cornerCal;

    /* lla info */
    a_uint16_t   ee_channels11a[NUM_11A_EEPROM_CHANNELS];
    a_uint16_t   ee_numChannels11a;
    DATA_PER_CHANNEL ee_dataPerChannel11a[NUM_11A_EEPROM_CHANNELS];

    a_uint16_t   ee_numChannels2_4;
    a_uint16_t   ee_channels11g[NUM_2_4_EEPROM_CHANNELS];
    a_uint16_t   ee_channels11b[NUM_2_4_EEPROM_CHANNELS];
    a_uint16_t   ee_spurChans[AR_EEPROM_MODAL_SPURS][2];
    ...
    RD_EDGES_POWER  ee_rdEdgesPower[NUM_EDGES*NUM_CTLS];
...
typedef HAL_BOOL HAL_READ_FUNC(struct ath_hal *, a_uint32_t off, a_uint16_t *data);
extern  HAL_BOOL ath_hal_readEepromIntoDataset(struct ath_hal *, HAL_EEPROM *);
extern  void ath_hal_eepromDetach(struct ath_hal *ah, HAL_EEPROM *ee);
