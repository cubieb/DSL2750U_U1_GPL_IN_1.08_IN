...
typedef struct _HTC_host_switch_table_s {
    A_STATUS   (*AddInstance)(HTC_HANDLE handle);
    void   (*DeleteInstance)(void *Instance,a_uint8_t surpriseRemoved);
...
typedef struct _HTC_INIT_INFO {
    ...
    void   (*TargetReadyEvent)(void *Context, a_uint32_t TotalCredits);
#endif
...
A_STATUS HTC_host_drv_deregister(void);
