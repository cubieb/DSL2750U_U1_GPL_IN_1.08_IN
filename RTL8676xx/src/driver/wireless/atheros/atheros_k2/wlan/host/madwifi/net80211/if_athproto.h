...
adf_os_packed_pre struct athl2p_tunnel_hdr {
#if (AH_BYTE_ORDER == AH_LITTLE_ENDIAN)
	a_uint32_t  offset	: 11,
	seqNum       		: 11,
	optHdrLen32  		: 2,
	frameType    		: 2,
	proto        		: 6;
...
//Temporary fix for Marvell interop. TODO: Use appropriate buffer size
#define ATH_FF_MAX_PAYLOAD 	3500
 ...
 */
#define ATH_FF_MAGIC_PUT(_anbuf)				\
	(((struct ieee80211_cb *) adf_nbuf_get_priv(_anbuf))->flags |= M_FF)

#define ATH_FF_MAGIC_CLR(_anbuf)				\
	(((struct ieee80211_cb *) adf_nbuf_get_priv(_anbuf))->flags &= ~M_FF)	

#define ATH_FF_MAGIC_PRESENT(_anbuf)				\
	((((struct ieee80211_cb *) adf_nbuf_get_priv(_anbuf))->flags & M_FF) != 0)	
