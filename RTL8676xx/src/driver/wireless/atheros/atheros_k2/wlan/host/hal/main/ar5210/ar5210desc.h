 ...
 * All rights reserved.
 *
 * $Id: //depot/sw/carriersrc/branches/magpie_host_dev/split_src/host/hal/main/ar5210/ar5210desc.h#5 $
 */
...
/* DMA descriptors */
adf_os_packed_pre struct ar5210_desc {
	...
	u_int32_t	ds_status0;	/* DMA status 0 */
	u_int32_t	ds_status1;	/* DMA status 1 */
} adf_os_packed_post;
...
#define TXCTL_NUMWORDS(ah)    2 
#define TXSTATUS_OFFSET(ah)   4
