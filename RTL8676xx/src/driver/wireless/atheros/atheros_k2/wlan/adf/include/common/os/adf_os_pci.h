 ...
 */
#ifndef __ADF_CMN_OS_PCI_H
#define __ADF_CMN_OS_PCI_H
...
adf_os_pci_config_read8(adf_os_device_t osdev, a_uint32_t offset, a_uint8_t *val)
{
 ...
 */ 
static adf_os_inline a_status_t 
adf_os_pci_config_write8(adf_os_device_t osdev, a_uint32_t offset, a_uint8_t val)
{
 ...
 */ 
static adf_os_inline a_status_t 
adf_os_pci_config_read16(adf_os_device_t osdev, a_uint32_t offset, a_uint16_t *val)
{
 ...
 */ 
static adf_os_inline a_status_t
adf_os_pci_config_write16(adf_os_device_t osdev, a_uint32_t offset, a_uint16_t val)
{
 ...
 */ 
static adf_os_inline a_status_t 
adf_os_pci_config_read32(adf_os_device_t osdev, a_uint32_t offset, a_uint32_t *val)
{
 ...
 */ 
static adf_os_inline a_status_t
adf_os_pci_config_write32(adf_os_device_t osdev, a_uint32_t offset, a_uint32_t val)
{
