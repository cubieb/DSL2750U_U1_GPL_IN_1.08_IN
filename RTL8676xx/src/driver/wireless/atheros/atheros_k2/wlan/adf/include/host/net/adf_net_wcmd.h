...
#ifndef __ADF_HST_NET_WCMD_H
#define __ADF_HST_NET_WCMD_H
...
#define ADF_NET_WCMD_CWMTYPE_INFO    SIOCDEVPRIVATE+2
#define ADF_NET_WCMD_CWMTYPE_DBG     SIOCDEVPRIVATE+3

#define ADF_NET_CAPINFO_ESS_IBSS        (3 << 0)
#define ADF_NET_CAPINFO_CF_PBITS        (3 << 2)
#define ADF_NET_CAPINFO_PRIV            (1 << 4)
#define ADF_NET_CAPINFO_SHORT_PBL       (1 << 5)
#define ADF_NET_CAPINFO_PBCC            (1 << 6)
#define ADF_NET_CAPINFO_CHAN_AGTY       (1 << 7)

#define ADF_NET_WCMD_DBG_MAXLEN         24
/**
 * *******************************Enums******************
 */
...
typedef enum adf_net_wcmd_type{
    ...
    ADF_NET_WCMD_SET_SCANDELAY,
    ADF_NET_WCMD_GET_SCANDELAY,
    /* Device specific */
...
#ifdef OMNI_MX_LED
    ADF_NET_WCMD_SET_LEDSTATS,   /*SAH MX LED control*/
#endif
    ...
    ADF_NET_WCMD_GET_DEV_HST_STATS,
    ADF_NET_WCMD_GET_DEV_HST_11N_STATS,
    ADF_NET_WCMD_GET_DEV_TGT_STATS,
    ADF_NET_WCMD_GET_DEV_TGT_11N_STATS,
#ifdef OMNI_MX_LED
    ADF_NET_WCMD_GET_LEDSTATS,       /*SAH MX LED get*/
#endif
    ADF_NET_WCMD_NOMINAL_NF,
    ADF_NET_WCMD_MIN_NOISE_FLOOR,
    ADF_NET_WCMD_MAX_NOISE_FLOOR,
    ADF_NET_WCMD_NF_DELTA,
    ADF_NET_WCMD_NF_WEIGHT,
    ADF_NET_WCMD_CHANNEL_SWITCH,
    /* For debugging purpose*/
    ADF_NET_WCMD_SET_DBG_INFO,
    ADF_NET_WCMD_GET_DBG_INFO,
    ADF_NET_WCMD_GET_REG,
    ADF_NET_WCMD_SET_REG,
    ADF_NET_WCMD_ENABLE_PKTLOG,
    ADF_NET_WCMD_DISABLE_PKTLOG,
    ADF_NET_WCMD_PKTLOG_SET_SIZE,
    ADF_NET_WCMD_PKTLOG_GET_DATA,
    ADF_NET_WCMD_GET_ETHER_DONGLE_MAC, 
    ADF_NET_WCMD_SET_ETHER_DONGLE_MAC, 
}adf_net_wcmd_type_t;
/**
...
typedef enum adf_net_wcmd_param_id{
    ...
    ADF_NET_WCMD_PARAM_MAXSTA,/**< Config max allowable stations for each VAP */
    ADF_NET_WCMD_PARAM_ETHER_DONGLE /**< Set Ether Dongle mode */
...
typedef enum adf_net_wcmd_dbg_type{
    ADF_NET_WCMD_DBG_TRIGGER = 1,
    ADF_NET_WCMD_DBG_CAP_PKT = 2,
    ADF_NET_WCMD_DBG_OTHER   = 3,
    ADF_NET_WCMD_DBG_MAX
}adf_net_wcmd_dbg_type_t;
...
enum {
    ADF_NET_WCMD_REASON_UNSPECIFIED         = 1,
    ADF_NET_WCMD_REASON_AUTH_EXPIRE         = 2,
    ADF_NET_WCMD_REASON_AUTH_LEAVE          = 3,
    ADF_NET_WCMD_REASON_ASSOC_EXPIRE        = 4,
    ADF_NET_WCMD_REASON_ASSOC_TOOMANY       = 5,
    ADF_NET_WCMD_REASON_NOT_AUTHED          = 6,
    ADF_NET_WCMD_REASON_NOT_ASSOCED         = 7,
    ADF_NET_WCMD_REASON_ASSOC_LEAVE         = 8,
    ADF_NET_WCMD_REASON_ASSOC_NOT_AUTHED    = 9,

    ADF_NET_WCMD_REASON_RSN_REQUIRED        = 11,
    ADF_NET_WCMD_REASON_RSN_INCONSISTENT    = 12,
    ADF_NET_WCMD_REASON_IE_INVALID          = 13,
    ADF_NET_WCMD_REASON_MIC_FAILURE         = 14,

    ADF_NET_WCMD_STATUS_SUCCESS             = 0,
    ADF_NET_WCMD_STATUS_UNSPECIFIED         = 1,
    ADF_NET_WCMD_STATUS_CAPINFO             = 10,
    ADF_NET_WCMD_STATUS_NOT_ASSOCED         = 11,
    ADF_NET_WCMD_STATUS_OTHER               = 12,
    ADF_NET_WCMD_STATUS_ALG                 = 13,
    ADF_NET_WCMD_STATUS_SEQUENCE            = 14,
    ADF_NET_WCMD_STATUS_CHALLENGE           = 15,
    ADF_NET_WCMD_STATUS_TIMEOUT             = 16,
    ADF_NET_WCMD_STATUS_TOOMANY             = 17,
    ADF_NET_WCMD_STATUS_BASIC_RATE          = 18,
    ADF_NET_WCMD_STATUS_SP_REQUIRED         = 19,
    ADF_NET_WCMD_STATUS_PBCC_REQUIRED       = 20,
    ADF_NET_WCMD_STATUS_CA_REQUIRED         = 21,
    ADF_NET_WCMD_STATUS_TOO_MANY_STATIONS   = 22,
    ADF_NET_WCMD_STATUS_RATES               = 23,
    ADF_NET_WCMD_STATUS_SHORTSLOT_REQUIRED  = 25,
    ADF_NET_WCMD_STATUS_DSSSOFDM_REQUIRED   = 26,
    ADF_NET_WCMD_STATUS_REFUSED             = 37,
    ADF_NET_WCMD_STATUS_INVALID_PARAM       = 38,
};
...
typedef struct adf_net_wcmd_vapname{
    a_uint32_t     len;
    char           name[ADF_NET_WCMD_NAME_SIZE];
...
typedef struct adf_net_wcmd_nickname{
    a_uint16_t      len;
    char            name[ADF_NET_WCMD_NICK_NAME];
...
typedef struct  adf_net_wcmd_ssid{
    char          byte[ADF_NET_WCMD_MAX_SSID];
...
typedef struct adf_net_wcmd_scan_result{
    ...
    a_uint8_t   isr_ssid[ADF_NET_WCMD_MAX_SSID];
    /* IE data */
    adf_net_ie_info_t   isr_wpa_ie;
    adf_net_ie_info_t   isr_wme_ie;
    adf_net_ie_info_t   isr_ath_ie; 
    adf_net_ie_info_t   isr_rsn_ie; 
    adf_net_ie_info_t   isr_wps_ie;
 ...
 */
typedef struct adf_net_vaplist {
    adf_net_ethaddr_t       mac;
    adf_net_wcmd_opmode_t   mode;
    adf_net_wcmd_linkqty_t  qual;
} adf_net_vaplist_t;        
...
typedef struct adf_net_wcmd_vaplist{
    adf_net_vaplist_t       list[ADF_NET_WCMD_MAX_AP];
    a_uint32_t              len;   
 ...
 */
typedef struct adf_net_wcmd_sta{
    ...
    a_uint8_t   isi_macaddr[ADF_NET_WCMD_ADDR_LEN];
    a_uint8_t   isi_nrates;/**< negotiated rates */
    a_uint8_t   isi_rates[ADF_NET_WCMD_RATE_MAXSIZE];
    ...
    a_uint8_t   isi_wpa_ie[ADF_NET_WCMD_IE_MAXLEN];
    a_uint8_t   isi_wme_ie[ADF_NET_WCMD_IE_MAXLEN];
    a_uint8_t   isi_ath_ie[ADF_NET_WCMD_IE_MAXLEN]; 
}adf_net_wcmd_sta_t;
/**
 * @brief list of stations
 */
typedef struct adf_net_wcmd_stainfo{
    adf_net_wcmd_sta_t   list[ADF_NET_WCMD_MAX_AP];
    a_uint32_t           len;
...
typedef struct adf_net_wcmd_hst_11n_phystats{
    a_uint32_t   tx_pkts;            /* total tx data packets */
    a_uint32_t   tx_checks;          /* tx drops in wrong state */
    a_uint32_t   tx_drops;           /* tx drops due to qdepth limit */
    a_uint32_t   tx_queue;           /* tx pkts when h/w queue is busy */
...
}adf_net_wcmd_hst_11n_phystats_t;

typedef struct adf_net_wcmd_hst_phystats{
    a_uint32_t   ast_watchdog;   /* device reset by watchdog */
    a_uint32_t   ast_tx_packets; /* packet sent on the interface */
    a_uint32_t   ast_tx_discard; /* frames discarded prior to assoc */
    a_uint32_t   ast_tx_invalid; /* frames discarded 'cuz device gone */
    ...
    /* 11n statistics */
    adf_net_wcmd_hst_11n_phystats_t ast_11n; 
    
}adf_net_wcmd_hst_phystats_t;

typedef struct adf_net_wcmd_tgt_11n_phystats{
...
}adf_net_wcmd_tgt_11n_phystats_t;


typedef struct adf_net_wcmd_tgt_phystats{
     a_uint32_t   ast_hardware;   /* fatal hardware error interrupts */
    a_uint32_t   ast_bmiss;  /* beacon miss interrupts */
    a_uint32_t   ast_rxorn;  /* rx overrun interrupts */
    a_uint32_t   ast_rxeol;  /* rx eol interrupts */
    ...
    /* 11n statistics */
    adf_net_wcmd_tgt_11n_phystats_t ast_11n; 

}adf_net_wcmd_tgt_phystats_t;
 ...
 */ 
typedef struct adf_net_wcmd_noisefloor_cmd {
    a_uint16_t get;
    a_int16_t val;
}adf_net_wcmd_noisefloor_cmd_t;
 ...
 *  exchange from the driver
 */ 
typedef struct adf_net_wcmd_dbg_info{
    adf_net_wcmd_dbg_type_t     type;
    a_uint8_t                   data[ADF_NET_WCMD_DBG_MAXLEN];
}adf_net_wcmd_dbg_info_t;


/**
 * @brief for getting/setting registers
 */
typedef struct adf_net_wcmd_reg{
    a_uint32_t addr;
    a_uint32_t val;
}adf_net_wcmd_reg_t;
/**
 ...
 */
 typedef struct adf_net_wcmd_pktlog_eventlist{
     a_uint32_t eventlist;
 }adf_net_wcmd_pktlog_eventlist_t;
...
/**
 * @brief scan delay set/get info
 */
typedef a_uint32_t     adf_net_wcmd_nextscandelay_t;
...
typedef union adf_net_wcmd_data{
    ...
    adf_net_wcmd_hst_phystats_t     *stats_hst;/* Host statistics */
    adf_net_wcmd_tgt_phystats_t     *stats_tgt;/* Target statistics */

    a_uint32_t                      datum;/*for sysctl*/
    adf_net_wcmd_noisefloor_cmd_t nf;
    adf_net_wcmd_dbg_info_t         dbg_info;/* Debugging purpose*/
    adf_net_wcmd_reg_t              reg;
    adf_net_wcmd_pktlog_eventlist_t pktlog_eventlist; /* Pktlog event list */
    adf_os_size_t           size;
    adf_net_wcmd_pktlog_read_t      *pktlog_read_info;
    adf_net_wcmd_nextscandelay_t     scandelay;
} adf_net_wcmd_data_t;
