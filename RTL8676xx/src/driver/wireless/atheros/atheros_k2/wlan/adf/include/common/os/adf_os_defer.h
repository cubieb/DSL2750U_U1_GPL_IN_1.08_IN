...
#ifndef __ADF_CMN_OS_DEFER_H
#define __ADF_CMN_OS_DEFER_H
...
{
    return __adf_os_init_bh(hdl, bh, func, arg);
}
...
{
    return __adf_os_sched_bh(hdl, bh);
}
...
{
    return __adf_os_disable_bh(hdl,bh);
}
...
adf_os_init_work(adf_os_handle_t hdl, adf_os_work_t  *work,
                 adf_os_defer_fn_t  func, void  *arg)
{
    return __adf_os_init_work(hdl, work, func, arg);
}
...
{
    return __adf_os_sched_work(hdl, work);
}
...
{
    return __adf_os_disable_work(hdl, work);
}
