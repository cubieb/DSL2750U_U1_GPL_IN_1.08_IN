...
typedef enum athcfg_wcmd_type{
    ...
    ATHCFG_WCMD_SET_DEV_TX_TIMEOUT,        /* XXX:No data definition */
    ATHCFG_WCMD_SET_DEV_MODE_INIT,         /* XXX:No data definition */
    ATHCFG_WCMD_GET_DEV_STATUS,            /* stats_phy */ 
    ATHCFG_WCMD_GET_DEV_STATUS_CLR,        /* XXX:No data definition */
...
typedef enum athcfg_wcmd_opmode{
    ...
    ATHCFG_WCMD_OPMODE_RESERVE0,/**<XXX: future use*/
    ATHCFG_WCMD_OPMODE_RESERVE1,/**<XXX: future use*/
    ATHCFG_WCMD_OPMODE_HOSTAP,/**< Software Access Point*/
    ATHCFG_WCMD_OPMODE_RESERVE2,/**<XXX: future use*/
    ATHCFG_WCMD_OPMODE_MONITOR/**< Monitor mode*/
}athcfg_wcmd_opmode_t;
/**
 * brief PHY modes for VAP
 */
typedef enum athcfg_wcmd_phymode{   /* TODO */
...
typedef struct athcfg_wcmd_ethtool_info{
    athcfg_wcmd_ethtool_cmd_t     cmd;/*XXX:???*/
...
typedef union athcfg_wcmd_data{
    athcfg_wcmd_vapname_t          vapname;/*XXX: ???*/
    ...
    athcfg_wcmd_vapstats_t         *stats_vap;/*XXX: name*/
...
/*
 * TODO: How do you get the first ununsed ioctl number?
 */ 
#ifdef OS_TYPE_LINUX
