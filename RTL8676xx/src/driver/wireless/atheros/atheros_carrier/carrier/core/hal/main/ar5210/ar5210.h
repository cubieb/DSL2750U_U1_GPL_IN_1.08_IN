 ...
 * All rights reserved.
 *
 * $Id: //depot/sw/carriersrc/release/1.3.1/src/madwifi/hal/main/ar5210/ar5210.h#1 $
 */
...
extern	HAL_BOOL ar5210PerCalibration(struct ath_hal *, HAL_CHANNEL *);
...
extern	HAL_BOOL ar5210CalNoiseFloor(struct ath_hal *, HAL_CHANNEL *);
...
extern  HAL_BOOL ar5210UpdateCTSForBursting(struct ath_hal *, struct ath_desc *,
...
extern   HAL_BOOL ar5210FillKeyTxDesc(struct ath_hal *ah,struct ath_desc *,HAL_KEY_TYPE);	
extern	HAL_STATUS ar5210ProcTxDesc(struct ath_hal *, struct ath_desc *);
extern  void ar5210GetTxIntrQueue(struct ath_hal *ah, u_int32_t *);
...
extern	HAL_BOOL ar5210GetRfKill(struct ath_hal *);
...
extern  HAL_BOOL ar5210SetDecompMask(struct ath_hal *, u_int16_t, int);
void 	ar5210SetCoverageClass(struct ath_hal *, u_int8_t, int);
...
extern void ar5210GetDescInfo(struct ath_hal *ah, HAL_DESC_INFO *desc_info);
...
extern	HAL_BOOL ar5210WaitForBeaconDone(struct ath_hal *, HAL_BUS_ADDR);
...
extern	void ar5210ArDisable(struct ath_hal *ah);
extern	void ar5210ResetAR(struct ath_hal *ah);
extern	void ar5210ArEnable(struct ath_hal *ah);
