...
#define AR_NUM_GPIO          10 // Ten numbered 0 to 9. it is 14 in fusion branch.
...
//Baseband registers    (region offset + (reg * 4))
#define AR_BB_TIMING_CONTROL_2        (0x9800 +   4 * 4)
#define AR_BB_CHAN_INFO_MEMORY        (0x9800 + 119 * 4)
#define AR_BB_CHAN_INFO_GAIN_DIFF     (0x9800 + 317 * 4)
#define AR_BB_CHAN_INFO_GAIN_DIFF_PPM_MASK          0xFFF
#define AR_BB_CHAN_INFO_GAIN_DIFF_PPM_SIGNED_BIT    0x800

#define AR_BB_CHAN_INFO_PPM           (0x9800 + 318 * 4)
#define AR_BB_CHAN_INFO_GAIN          (0x9800 + 319 * 4)
