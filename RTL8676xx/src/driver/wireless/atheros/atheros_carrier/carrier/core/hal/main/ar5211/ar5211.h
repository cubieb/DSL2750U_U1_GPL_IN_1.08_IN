 ...
 * All rights reserved.
 *
 * $Id: //depot/sw/carriersrc/release/1.3.1/src/madwifi/hal/main/ar5211/ar5211.h#1 $
 */
...
extern	HAL_BOOL ar5211PerCalibration(struct ath_hal *, HAL_CHANNEL *);
extern	int16_t ar5211GetNoiseFloor(struct ath_hal *);
...
extern	HAL_BOOL ar5211CalNoiseFloor(struct ath_hal *, HAL_CHANNEL *);
...
extern  HAL_BOOL ar5211UpdateCTSForBursting(struct ath_hal *, struct ath_desc *,
...
extern   HAL_BOOL ar5211FillKeyTxDesc(struct ath_hal *ah,struct ath_desc *,HAL_KEY_TYPE);	
extern	HAL_STATUS ar5211ProcTxDesc(struct ath_hal *, struct ath_desc *);
extern  void ar5211GetTxIntrQueue(struct ath_hal *ah, u_int32_t *);
...
extern	HAL_BOOL ar5211GetRfKill(struct ath_hal *);
...
extern  HAL_BOOL ar5211SetDecompMask(struct ath_hal *, u_int16_t, int);
void 	ar5211SetCoverageClass(struct ath_hal *, u_int8_t, int);
...
extern void ar5211GetDescInfo(struct ath_hal *ah, HAL_DESC_INFO *desc_info);
...
extern	HAL_BOOL ar5211WaitForBeaconDone(struct ath_hal *, HAL_BUS_ADDR);
...
extern	void ar5211ArDisable(struct ath_hal *ah);
extern	void ar5211ResetAR(struct ath_hal *ah);
extern	void ar5211ArEnable(struct ath_hal *ah);
