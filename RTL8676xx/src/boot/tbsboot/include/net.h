...
extern int eth_get_link_state(void); /* get link state of current device */
...
#define IPPROTO_TCP	 6	/* Internet Control Message Protocol	*/
...
typedef enum { BOOTP, RARP, ARP, TFTP, DHCP, PING, DNS, NFS, CDP, NETCONS, SNTP ,TCP} proto_t;

/* from net/net.c */
extern char	BootFile[128];			/* Boot File name		*/
extern IPaddr_t NetTftpServerIP;                /* the ip address to tftp        */
...
/* Checksum */
extern int NetCksumOk(volatile unsigned short *, int);	/* Return true if cksum OK	*/
extern unsigned short NetCksum(volatile unsigned short *, int);		/* Calculate the checksum	*/
...
extern IPaddr_t getenv_netmask( void );
