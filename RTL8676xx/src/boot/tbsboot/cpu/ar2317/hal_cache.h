...
#define HAL_DCACHE_SYNC()                                               \
    CYG_MACRO_START                                                     \
    register unsigned int _baddr_ = 0x80000000;                          \
    register unsigned int _addr_ = 0x80000000;                           \
    register unsigned int _size_ = HAL_DCACHE_SIZE;                         \
...
#define HAL_DCACHE_LOCK(_base_, _asize_)                                    \
    CYG_MACRO_START                                                         \
    register unsigned int  _addr_  = HAL_DCACHE_START_ADDRESS(_base_);        \
    register unsigned int _eaddr_ = HAL_DCACHE_END_ADDRESS(_base_, _asize_); \
    register unsigned int _state_;                                              \
...
#define HAL_ICACHE_LOCK(_base_, _asize_)                                    \
    CYG_MACRO_START                                                         \
    register unsigned int _addr_  = HAL_ICACHE_START_ADDRESS(_base_);        \
    register unsigned int _eaddr_ = HAL_ICACHE_END_ADDRESS(_base_, _asize_); \
    register unsigned int _state_;                                              \
