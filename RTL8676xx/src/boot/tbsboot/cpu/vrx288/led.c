...
//cathy
#define IS_6028A		(((*( unsigned int * )(0xB8003200) & 0x00110000) == 0x00110000) ? 1:0)	//b20=1, b16=1
#define IS_6028B		(((*( unsigned int * )(0xB8003200) & 0x00110000) == 0x00100000) ? 1:0)	//b20=1, b16=0
#define IS_6028C		(((*( unsigned int * )(0xB8003200) & 0x00110000) == 0x00110000) ? 1:0)	//b20=1, b16=1
#define IS_6085		(((*( unsigned int * )(0xB8003200) & 0x00110000) == 0x00010000) ? 1:0)	//b20=0, b16=1
