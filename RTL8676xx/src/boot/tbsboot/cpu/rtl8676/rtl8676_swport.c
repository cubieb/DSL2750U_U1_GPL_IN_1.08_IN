...
static u32 _rtk_switch_init_setreg(u32 reg, u32 data)
{
...
u32 rtk_switch_init(void)
{
    ...
    if(init_para == ChipData00)
    {
        if(data & 0xF000)
        {
            ...
            init_size = (sizeof(ChipData01) / ((sizeof(u16))*2));
        }
        else
            init_size = (sizeof(ChipData00) / ((sizeof(u16))*2));
    }
    else if(init_para == ChipData10)
    {
        if(data & 0xF000)
        {
            ...
            init_size = (sizeof(ChipData11) / ((sizeof(u16))*2));
        }
        else
            init_size = (sizeof(ChipData10) / ((sizeof(u16))*2));
    }
    else if(init_para == ChipData20)
    {
        if(data & 0xF000)
        {
            ...
            init_size = (sizeof(ChipData21) / ((sizeof(u16))*2));
        }
        else
            init_size = (sizeof(ChipData20) / ((sizeof(u16))*2));
    }
    ...
    else if(init_para == ChipData40)
    {
        if(data & 0xF000)
        {
            ...
            init_size = (sizeof(ChipData41) / ((sizeof(u16))*2));
        }
        else
            init_size = (sizeof(ChipData40) / ((sizeof(u16))*2));
    }
    else if(init_para == ChipData50)
    {
        if(data & 0xF000)
        {
            ...
            init_size = (sizeof(ChipData51) / ((sizeof(u16))*2));
        }
        else
            init_size = (sizeof(ChipData50) / ((sizeof(u16))*2));
    }
    else if(init_para == ChipData60)
    {
        if(data & 0xF000)
        {
            ...
            init_size = (sizeof(ChipData61) / ((sizeof(u16))*2));
        }
        else
            init_size = (sizeof(ChipData60) / ((sizeof(u16))*2));
    }
    else if(init_para == ChipData70)
    {
        if(data & 0xF000)
        {
            ...
            init_size = (sizeof(ChipData71) / ((sizeof(u16))*2));
        }
        else
            init_size = (sizeof(ChipData70) / ((sizeof(u16))*2));
    }
    else if(init_para == ChipData80)
    {
        if(data & 0xF000)
        {
            ...
            init_size = (sizeof(ChipData81) / ((sizeof(u16))*2));
        }
        else
            init_size = (sizeof(ChipData80) / ((sizeof(u16))*2));
    }
    else if(init_para == ChipData90)
    {
        if(data & 0xF000)
        {
            ...
            init_size = (sizeof(ChipData91) / ((sizeof(u16))*2));
        }
        else
            init_size = (sizeof(ChipData90) / ((sizeof(u16))*2));
    }
    ...
    {
        if((retVal = _rtk_switch_init_setreg((u32)init_para[i][0], (u32)init_para[i][1])) != RT_ERR_OK)
            return retVal;
    }
...
void RL6000_RGMII(void){
	...
	smi_write(RTL8367B_REG_EXT1_RGMXF, 0xd);
}
#endif
