...
#define AR7100_IF_GMII  0
#define AR7100_IF_MII   1
#define AR7100_IF_RGMII 2
#define AR7100_IF_RMII  3
...
{
    uint32_t mii_ctrl = (mac->mac_unit)?AR7100_MII1_CTRL:AR7100_MII0_CTRL;

    ar7100_reg_rmw_clear(mii_ctrl, (3 << 4));
    if(spd == AG7100_PHY_SPEED_100TX) { 
        ar7100_reg_rmw_set(mii_ctrl,  0x10);    
    } else if(spd == AG7100_PHY_SPEED_1000T) {
        ar7100_reg_rmw_set(mii_ctrl, 0x20);
    }
}
