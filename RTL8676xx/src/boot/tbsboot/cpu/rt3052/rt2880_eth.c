...
#include <common.h>
#include <command.h>
//#include <star_pci_bridge.h>

#if (CONFIG_COMMANDS & CFG_CMD_NET) && defined(CONFIG_NET_MULTI) \
	&& defined(CONFIG_RT2880_ETH)
...
void RESET_RT2880_ETH(struct eth_device *dev)
{
	u_long value;
	...
	value |= (1 << 18);
#else
	//2880 -> 3052/2883 reset Frame Engine from 18 to 21
	value |= (1 << 21);
#endif
...
#if defined (RT3052_ASIC_BOARD)
	RT2882_REG(0xb01100C8) = 0x3f502b28; 
	RT2882_REG(0xb0110084) = 0x00000000;
#elif defined (RT3052_FPGA_BOARD)
	RT2882_REG(0xb01100C8) = 0x3ff02b28; 
	RT2882_REG(0xb0110084) = 0xffdf1f00;
...
#define SDRAM_BASE_ADDR CONFIG_DRAM_BASE
