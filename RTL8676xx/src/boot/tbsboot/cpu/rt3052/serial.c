...
#elif defined(RT2883_ASIC_BOARD) || defined(RT2883_FPGA_BOARD) || defined(RT3052_ASIC_BOARD) || defined(RT3052_FPGA_BOARD)
	*(unsigned long *)(RALINK_SYSCTL_BASE + 0x0034) = cpu_to_le32(1<<19);
#else
