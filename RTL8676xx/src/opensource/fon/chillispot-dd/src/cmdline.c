...
#ifdef SUPPORT_HOTWIFI
          else if (strcmp (long_options[option_index].name, "maxconntracks") == 0)
          {
            args_info->max_conntracks = strtol (optarg,&stop_char,0);
          }
          else if (strcmp (long_options[option_index].name, "maxusers") == 0)
          {
            args_info->max_users = strtol (optarg,&stop_char,0);
          }
#endif
