...
static const struct reject_names reject_table[] = {
  ...
  /*alias*/    
	{"icmpv6-no-route-to-destination", "no-route",
		IP6T_ICMP6_NO_ROUTE, "ICMPv6 no route"},
	{"icmp6-adm-prohibited", "adm-prohibited",
		IP6T_ICMP6_ADM_PROHIBITED, "ICMPv6 administratively prohibited"},
  /*alias*/    
    {"icmpv6-administratively-prohibited", "adm-prohibited",
        IP6T_ICMP6_ADM_PROHIBITED, "ICMPv6 administratively prohibited"},		
	{"icmp6-not-neighbor", "not-neighbor",
		IP6T_ICMP6_NOT_NEIGHBOUR, "ICMPv6 not a neighbor"},
	{"icmp6-addr-unreachable", "addr-unreach",
		IP6T_ICMP6_ADDR_UNREACH, "ICMPv6 address unreachable"},
   /*alias*/  
	{"icmpv6-address-unreachable", "addr-unreach",
		IP6T_ICMP6_ADDR_UNREACH, "ICMPv6 address unreachable"},
	{"icmp6-port-unreachable", "port-unreach",
		IP6T_ICMP6_PORT_UNREACH, "ICMPv6 port unreachable"},
   /*alias*/  
    {"icmpv6-port-unreachable", "port-unreach",
        IP6T_ICMP6_PORT_UNREACH, "ICMPv6 port unreachable"},
	{"icmpv6-source-address-failed", "source address failed",
		IP6T_ICMP6_SADDR_FAILED, "ICMPv6 source address failed"},	
    {"icmpv6-reject-route-to-destination", "reject route to destination",
        IP6T_ICMP6_REJECT_ROUTE_DEST, "ICMPv6 reject route to destination"},   
	{"tcp-reset", "tcp-reset",
