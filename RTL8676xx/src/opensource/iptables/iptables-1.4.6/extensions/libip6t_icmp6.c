...
static const struct icmpv6_names icmpv6_codes[] = {
	...
	{   "no-route", 1, 0, 0 },
	/* Alias */ { "no-route-to-destination", 1, 0, 0 },
	{   "communication-prohibited", 1, 1, 1 },
	/* Alias */ {   "administratively-prohibited", 1, 1, 1 },
	...
	/* Alias */ { "hop-limit-exceeded", 3, 0, 0 },
	{   "ttl-zero-during-reassembly", 3, 1, 1 },
	/* Alias */ {   "fragment-reassembly-time-exceeded", 3, 1, 1 },

	{ "parameter-problem", 4, 0, 0xFF },
	{   "bad-header", 4, 0, 0 },
	/* Alias */ {   "erroneous-header-field", 4, 0, 0 },
	{   "unknown-header-type", 4, 1, 1 },
	/* Alias */ {   "unrecognized-next-header-type", 4, 1, 1 },
	{   "unknown-option", 4, 2, 2 },
	/* Alias */ {   "unrecognized-ipv6-option", 4, 2, 2 },
	...
	{ "multicast-listener-query", 130, 0, 0 },

	{ "multicast-listener-report", 131, 0, 0 },

	{ "multicast-listener-done", 132, 0, 0 },
