/*
 * WPA Supplicant - driver interaction with ATHEROS 802.11 driver
...
#undef IEEE80211_IOCTL_SETWMMPARAMS /* AV: force off */
...
#else /* ATHEROS_NG */
			int first = IEEE80211_IOCTL_SETPARAM;
			int last = IEEE80211_IOCTL_CHANSWITCH;
			static const char *opnames[] = {
				"ioctl[IEEE80211_IOCTL_SETPARAM]",
				"ioctl[IEEE80211_IOCTL_GETPARAM]",
				"ioctl[IEEE80211_IOCTL_SETKEY]",
...
const struct wpa_driver_ops wpa_driver_atheros_ops = {
	.name			= "atheros",
	.desc			= "ATHEROS 802.11 support (Atheros, etc.)",
