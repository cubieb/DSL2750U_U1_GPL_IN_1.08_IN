...
static const char cmds[] = {
	...
	'e', 'g', 'r', 'e', 's', 's', '_',
	'm', 'a', 'p', 0,
	5, SET_VLAN_INGRESS_PRIORITY_CMD, 19,
	's', 'e', 't', '_',
	'i', 'n', 'g', 'r', 'e', 's', 's', '_',
	'm', 'a', 'p', 0,
	4, SET_VLAN_QINQ_CMD, 12,
	's', 'e', 't', '_', 
	'q', 'i', 'n', 'q', 0, 
};
...
int vconfig_main(int argc, char **argv)
{
	...
	if (ifr.cmd == SET_VLAN_NAME_TYPE_CMD) { /* set_name_type */
		...
		} else if(ifr.cmd == SET_VLAN_QINQ_CMD){
		    ifr.u.qinq_enable = xatou(p);
        } else if (ifr.cmd != DEL_VLAN_CMD) { /* set_{egress|ingress}_map | set_qinq */
