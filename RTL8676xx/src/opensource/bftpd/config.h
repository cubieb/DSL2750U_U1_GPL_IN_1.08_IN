...
/* for TBS ftp upgrade module */
#define TBS_FTPUPG 1

/* max image file size , 8M (8*1024*1024) */
#define TBS_MAX_IMG_SIZE  8388608

/* max config file size , 100K */
#define TBS_MAX_CONFIG_SIZE (unsigned long)512*1024
