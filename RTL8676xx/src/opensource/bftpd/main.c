...
void FTPUPG_MsgPorcess()
{
	bftpd_log("Receive a message.\n");
}
...
int main(int argc, char **argv)
{
	...
	if (TBS_SUCCESS != (MSG_RegModule(MID_FTPUPG, FTPUPG_MsgPorcess)))  
	{		
		bftpd_log("RegModule failed, exit.\n");
		return 0;
	}
	
	MSG_AllModStartOK();
	bftpd_log("RegModule success.\n");
	...
	control_printf(SL_SUCCESS, "220 Welcome to TBS FTP Server.");
