...
extern int br_set_port_priority(const char *br, const char *p, 
				int port_priority);
extern int br_mld_set_port_snooping(const char *br, const char *port, const char *addr);
extern int br_mld_clear_port_snooping(const char *br, const char *port, const char *addr);
extern int br_mld_enable_port_snooping(int enable);
...
#ifdef CONFIG_VLAN_MODE
extern int br_vlan_set(const char *port, VLAN_MODE_T *vlan);
extern int br_vlan_show(const char *port);
#endif
#endif
