...
#define	TBS_CMD_SUPPORT	1
#define	TBS_CMD_SUPPORT	1
#define	TBS_LIST_SUPPORT	1
#define	TBS_RIP_DEBUG	1

#if defined(TBS_CMD_SUPPORT)
/* Vty events */
enum event 
  {
    VTY_SERV,
...
#if defined(TBS_RIP_DEBUG) || defined(TBS_CMD_SUPPORT)
...
#endif /* defined(TBS_RIP_DEBUG) || defined(TBS_CMD_SUPPORT) */

#if defined(TBS_CMD_SUPPORT) || defined(TBS_RIP_DEBUG)
