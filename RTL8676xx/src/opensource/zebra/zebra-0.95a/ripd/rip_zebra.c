...
#if defined(TBS_LIST_SUPPORT) && defined(TBS_CMD_SUPPORT)
...
#endif /* TBS_LIST_SUPPORT && TBS_CMD_SUPPORT */
...
#if defined(TBS_CMD_SUPPORT) && defined(TBS_LIST_SUPPORT)  
  /* Install zebra node. */
