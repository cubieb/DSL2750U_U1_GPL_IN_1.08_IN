...
/*The follow global variables define in upnpdescgen.c*/
extern char g_szManufacturer[128] ;
extern char g_szModelName[128] ;
extern char g_szModelDescription[128] ;
extern char g_szProductClass[128];
	...
	while(fgets(buffer, sizeof(buffer), hfile))
	{
		...
		*equals = '\0';
		...
		while(isspace(*value))
            ...
            /*get device information from/etc/upnpd.conf*/
            /*Manufacturer*/
		if (0 == strcmp(name,"Manufacturer"))
		{
		    strcpy(g_szManufacturer,value);
		    continue;
		}

            /*ModelName*/
		if (0 == strcmp(name,"ModelName"))
		{
		    strcpy(g_szModelName,value);
		    continue;
		}

            /*Description*/
		if (0 == strcmp(name,"Description"))
		{
		    strcpy(g_szModelDescription,value);
		    continue;
		}

		/*ProductClass*/
		if (0 == strcmp(name,"ProductClass"))
		{
#ifdef CONFIG_TELEFONICA_CHILE
		    strcpy(g_szProductClass, "HOMESTATION");
#else
		    strcpy(g_szProductClass,value);
#endif
		    continue;
		}

		/*wan ip addr*/
		if (0 == strcmp(name,"WanIpAddr"))
		{
		    strcpy(g_szWanIpAddr,value);
		    continue;
		}
