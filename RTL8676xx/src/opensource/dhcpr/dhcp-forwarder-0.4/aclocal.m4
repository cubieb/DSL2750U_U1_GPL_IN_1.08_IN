...
dnl $Id: aclocal.m4,v 1.1.1.1 2003/11/25 22:14:04 jharrell Exp $
...
AC_DEFUN([ENSC_HEADER_IF_PACKET],
[
	old_cppflags="$CPPFLAGS"
	CPPFLAGS="-I ${srcdir}"
	AC_CHECK_HEADER([compat/if_packet.h],[],
			[AC_MSG_ERROR([
*** Do not know how to use L2 protocol-header; please
*** adjust compat/if_packet.h and report your changes
