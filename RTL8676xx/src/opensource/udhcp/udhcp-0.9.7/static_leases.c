...
/* Modified: append flgFoundMac to mark some MAC exist but binding IP is not exist.  20090422 radar*/
uint32_t getIpByMac(struct static_lease *lease_struct, void *arg, unsigned char *flgFoundMac)
{
	uint32_t return_ip;
