...
#else
/*****************************************************/
#define NETSNMP_ENTERPRISE_OID			33003
#define NETSNMP_ENTERPRISE_MIB			1,3,6,1,4,1,33003
#define NETSNMP_ENTERPRISE_DOT_MIB		1.3.6.1.4.1.33003
#define NETSNMP_ENTERPRISE_DOT_MIB_LENGTH	7

/* The assigned enterprise number for sysObjectID. */
#define NETSNMP_SYSTEM_MIB		1,3,6,1,4,1,33003
#define NETSNMP_SYSTEM_DOT_MIB		1.3.6.1.4.1.33003
#define NETSNMP_SYSTEM_DOT_MIB_LENGTH	7

/* The assigned enterprise number for notifications. */
#define NETSNMP_NOTIFICATION_MIB		1,3,6,1,4,1,33003,99
#define NETSNMP_NOTIFICATION_DOT_MIB		1.3.6.1.4.1.33003.99
#define NETSNMP_NOTIFICATION_DOT_MIB_LENGTH	8
/****************************************************************/
#endif
