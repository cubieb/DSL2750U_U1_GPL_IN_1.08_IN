...
int open_socket_in( int type, int port, int dlevel, uint32 socket_addr, BOOL rebind )
{
    ...
    #if 0
    //»º³åÇø
    int nSendBuf = 3145728;
    if(setsockopt(res, SOL_SOCKET, SO_SNDBUF, (const char*)&nSendBuf, sizeof(int)) == -1) {
        printf("........................\n");
        printf("........................\n");
        printf("........................\n");
        printf("........................\n");
    ...
    if(setsockopt(res, SOL_SOCKET, SO_RCVBUF, (const char*)&nSendBuf, sizeof(int)) == -1) {
        printf("........................\n");
        printf("........................\n");
        printf("........................\n");
        printf("........................\n");
