			...
			SMB_STRUCT_STAT *pst)
{
	...
	*dirpath = 0;
	...
	dprintf("hebo debug in unix_convert: step1\n");
	...
	dprintf("hebo debug in unix_convert: step2\n");
	...
	dprintf("hebo debug in unix_convert: step3\n");
	...
	dprintf("hebo debug in unix_convert: step4\n");
	...
	dprintf("hebo debug in unix_convert: step5\n");
	...
	dprintf("hebo debug in unix_convert: step6\n");
	...
	dprintf("hebo debug in unix_convert: step7\n");
	...
	dprintf("hebo debug in unix_convert: step8\n");
	...
	dprintf("hebo debug in unix_convert: step9\n");
	...
	dprintf("hebo debug in unix_convert: step10\n");
	...
	dprintf("hebo debug in unix_convert: step11\n");
	...
	DEBUG(5,("conversion finished %s -> %s\n",orig_path, name));
	dprintf("hebo debug in unix_convert: step12\n");
	return NT_STATUS_OK;
}
