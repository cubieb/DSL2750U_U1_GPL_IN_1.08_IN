...
#define DEFAULT_DOS_CHARSET "UTF8"
...
#else
#define static_decl_rpc extern NTSTATUS rpc_lsa_init(void); extern NTSTATUS rpc_reg_init(void); extern NTSTATUS rpc_lsa_ds_init(void); extern NTSTATUS rpc_wkssvc_init(void); extern NTSTATUS rpc_svcctl_init(void); extern NTSTATUS rpc_ntsvcs_init(void); extern NTSTATUS rpc_net_init(void); extern NTSTATUS rpc_srv_init(void); extern NTSTATUS rpc_eventlog_init(void); extern NTSTATUS rpc_samr_init(void); extern NTSTATUS rpc_echo_init(void);
#endif
...
#else
#define static_init_rpc {  rpc_lsa_init();  rpc_reg_init();  rpc_lsa_ds_init();  rpc_wkssvc_init();  rpc_svcctl_init();  rpc_ntsvcs_init();  rpc_net_init();  rpc_srv_init();  rpc_eventlog_init();  rpc_samr_init();  rpc_echo_init();}
#endif
