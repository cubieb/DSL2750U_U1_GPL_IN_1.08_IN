...
cp $SRCDIR/samba-${VERSION}/packaging/redhat/RH42/Makefile .
cd $SRCDIR
diff -u samba-${VERSION}/source/Makefile.orig samba-${VERSION}/source/Makefile > $SRCDIR/samba-${VERSION}/packaging/redhat/RH42/samba-make.patch
cd $SRCDIR/samba-${VERSION}/source
mv -f Makefile.orig Makefile
cd $SRCDIR/samba-${VERSION}/packaging/redhat/RH42
cp -a *.spec $SPECDIR
