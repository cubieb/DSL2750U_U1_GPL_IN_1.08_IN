...
/*! \fn int ILibWebClient_Parse_Range(char *Range, off_t *Start, off_t *Length, off_t TotalLength)
...
*/
enum ILibWebClient_Range_Result ILibWebClient_Parse_Range(char *Range, off_t *Start, off_t *Length, off_t TotalLength)
{
