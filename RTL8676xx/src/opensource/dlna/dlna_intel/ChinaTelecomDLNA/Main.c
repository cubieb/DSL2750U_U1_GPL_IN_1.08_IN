...
int main(void) 
{
	...
	MediaServer_GetConfiguration()->Manufacturer = "Digital Media Server";
	MediaServer_GetConfiguration()->ManufacturerURL = "Digital Media Server";
	MediaServer_GetConfiguration()->ModelName = "Digital Media Server";
	MediaServer_GetConfiguration()->ModelDescription = "Digital Media Server";
	MediaServer_GetConfiguration()->ModelNumber = "Digital Media Server";
	MediaServer_GetConfiguration()->ModelURL = "Digital Media Server";
	...
	DMSObject = DMS_Create(
		...
		"11bac2a5-3dc4-4cbe-a607-5de166cc577e",
		"0000001",
		0,
		0,
		"",
