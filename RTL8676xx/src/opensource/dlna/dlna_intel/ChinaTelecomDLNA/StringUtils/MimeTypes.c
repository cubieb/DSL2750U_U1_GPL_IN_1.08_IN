...
const char* FileExtensionToDlnaProfile (const char* extension, int wide)
{
	...
	else if (stricmp(extension, EXTENSION_VIDEO_AVI) == 0)
	{
		retVal = DLNAPROFILE_AVI;
	}
	else if (stricmp(extension, EXTENSION_VIDEO_RM) == 0)
	{
		retVal = DLNAPROFILE_RM;
	}
	else if (stricmp(extension, EXTENSION_VIDEO_RMVB) == 0)
	{
		retVal = DLNAPROFILE_RMVB;
	}
	else if (stricmp(extension, EXTENSION_VIDEO_MP4) == 0)
	{
		retVal = DLNAPROFILE_MP4;
	}
	else if (stricmp(extension, EXTENSION_VIDEO_3GP) == 0)
	{
		retVal = DLNAPROFILE_3GP;
	}
	else if (stricmp(extension, EXTENSION_VIDEO_MKV) == 0)
	{
		retVal = DLNAPROFILE_MKV;
	}
	else if (stricmp(extension, EXTENSION_VIDEO_MOV) == 0)
	{
		retVal = DLNAPROFILE_MOV;
	}
	else if (stricmp(extension, EXTENSION_VIDEO_MPEG) == 0)
	{
		retVal = DLNAPROFILE_MPEG;
	}
	else
	{
		retVal = "";
...
const char* DlnaProfileToFileExtension (const char* dlna_profile)
{
	...
	else if (stricmp(dlna_profile, DLNAPROFILE_MP4) == 0)
	{
		return EXTENSION_VIDEO_MP4;
	}
	else if (stricmp(dlna_profile, DLNAPROFILE_3GP) == 0)
	{
		return EXTENSION_VIDEO_3GP;
	}
	else if (stricmp(dlna_profile, DLNAPROFILE_MKV) == 0)
	{
		return EXTENSION_VIDEO_MKV;
	}
	else if (stricmp(dlna_profile, DLNAPROFILE_MOV) == 0)
	{
		return EXTENSION_VIDEO_MOV;
	}
	else if (stricmp(dlna_profile, DLNAPROFILE_MPEG) == 0)
	{
...
const char* FileExtensionToMimeType (const char* extension, int wide)
{
	...
	{
		retVal = MIME_TYPE_VIDEO_AVI;
	}
	else if (stricmp(extension, EXTENSION_VIDEO_RM) == 0)
	{
		retVal = MIME_TYPE_VIDEO_RM;
	}
	else if (stricmp(extension, EXTENSION_VIDEO_RMVB) == 0)
	{
		retVal = MIME_TYPE_VIDEO_RMVB;
	}
	else if (stricmp(extension, EXTENSION_VIDEO_MP4) == 0)
	{
		retVal = MIME_TYPE_VIDEO_MP4;
	}
	else if (stricmp(extension, EXTENSION_VIDEO_3GP) == 0)
	{
		retVal = MIME_TYPE_VIDEO_3GP;
	}
	else if (stricmp(extension, EXTENSION_VIDEO_MKV) == 0)
	{
		retVal = MIME_TYPE_VIDEO_MKV;
	}
	else if (stricmp(extension, EXTENSION_VIDEO_MOV) == 0)
	{
