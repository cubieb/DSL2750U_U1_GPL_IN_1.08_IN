 ...
 * Revision History:
 * 
 * $brcm_Log: /AppLibs/dlna/MediaServer/CDS_Iface.h $
 * 
...
#ifndef _CDS_IFACE_H_
#define _CDS_IFACE_H_
#include "CDS.h"
...
/* 
* SEARCH IS NOT OMPLEMENTED YET
* ------------------------------
* BUPnPError cds_search_if(BUPnPServiceHandle hService, BUPnPActionHandle hAction);
*/
...
void    cds_service_start_if(char * baseServerUrl,
                             char *ContentDir);
