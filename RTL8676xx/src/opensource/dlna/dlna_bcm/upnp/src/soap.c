...
static void BUPnPSoap_Data(nxml_t handle, const char *tag_name, unsigned len)
{
    ...
    hAction = pParserArg->hAction;
    strncpy(argumentName, handle->lastStartTag, handle->lastStartTagLen);
