 ...
 * Revision History:
 * 
 * $brcm_Log: /AppLibs/upnp/src/soap.h $
 * 
 * 2   9/30/09 3:33p dliu
 * SW7405-2482: Add support for dynamic service creation
* 
***************************************************************************/
#ifndef SOAPSERVER_H__
#define SOAPSERVER_H__
...
BUPnPError Soap_ProcessPost( HttpContext* pContext );
