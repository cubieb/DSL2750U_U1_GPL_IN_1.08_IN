 ...
 * $brcm_Revision: 2 $
 * $brcm_Date: 9/30/09 3:30p $
 * 
 * Module Description:
 * 
 * Revision History:
 * 
 * $brcm_Log: /AppLibs/upnp/src/timer.h $
 * 
 * 2   9/30/09 3:30p dliu
...
typedef struct _Timer *TimerHandle;

typedef void (*Timer_EventCallback)(TimerHandle hTimer, void* param);     
...
void Timer_BlockEvents(void);
void Timer_UnblockEvents(void);
