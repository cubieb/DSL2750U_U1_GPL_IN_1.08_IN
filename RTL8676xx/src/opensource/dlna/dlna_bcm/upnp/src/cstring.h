...
*  ANY LIMITED REMEDY.
 *
 * $brcm_Workfile: cstring.h $
 * $brcm_Revision: 2 $
 * $brcm_Date: 9/30/09 4:15p $
 * 
 * Module Description:
 * 
 * Revision History:
 * 
 * $brcm_Log: /AppLibs/upnp/src/cstring.h $
 * 
 * 2   9/30/09 4:15p dliu
...
bool CString_SetText(cstring_t* pstr, const char *fmt);
