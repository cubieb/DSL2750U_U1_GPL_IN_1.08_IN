 ...
 * Revision History:
 * 
 * $brcm_Log: /AppLibs/dlna/dms/buffer.h $
 * 
 * 2   7/24/09 7:35p ajitabhp
 * PR55165: Fixed the variable argument issue that we were facing on some
 *  builds.
 * 
 *****************************************************************************/
...
#define buffer_appendf(X,fmt,...) buffer_appendf_new(X,fmt, __VA_ARGS__)
void buffer_appendf_new(struct buffer_t *buffer, const char *format, ...);
