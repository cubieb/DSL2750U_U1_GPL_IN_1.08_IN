...
#define SSDP_REFRESH    1800 /* seconds */

typedef enum { SsdpAdvertisementType_Alive, SsdpAdvertisementType_ByeBye } SsdpAdvertisementType;
...
BUPnPError Ssdp_SendStartupAdvertisement(void);
