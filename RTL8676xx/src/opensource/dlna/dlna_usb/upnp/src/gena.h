...
BUPnPError Gena_ProcessSubscribe( HttpContext* pContext );

BUPnPError Gena_ProcessUnsubscribe( HttpContext* pContext );
...
BUPnPError Gena_ProcessNotify(HttpContext* pContext);
