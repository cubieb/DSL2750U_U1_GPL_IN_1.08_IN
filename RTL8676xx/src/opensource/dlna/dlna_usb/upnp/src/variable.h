...
* 
***************************************************************************/
#ifndef UPNPVARIABLE_H__
#define UPNPVARIABLE_H__
...
struct BUPnPStateVariable
{
    ...
    BUPnPStateVariableInfo* variableInfo;
    
    BLST_ENTRY(BUPnPStateVariable) link;
};
