...
* 
***************************************************************************/
#ifndef BUPnPAction_H__
#define BUPnPAction_H__
...
struct BUPnPArgument
{
    const char* name;

    cstring_t value;

    BUPnPArgumentInfo* argumentInfo;
};
...
struct BUPnPAction
{
    ...
    struct BUPnPArgument* arguments;
    size_t argumentCount;
    size_t inArgumentCount;

    BUPnPActionInfo *actionInfo;

    BLST_ENTRY(BUPnPAction) link;
};
