...
CountryList[24]=new Citem("Thailand", 10);
...
ISPList[89]=new ISPitem("Thailand", "3BB", "PPPoE", "LLC", 0, 33, 0);
ISPList[90]=new ISPitem("Thailand", "ADC", "PPPoE", "LLC", 0, 35, 0);
ISPList[91]=new ISPitem("Thailand", "CS-Loxinfo", "PPPoE", "LLC", 0, 35, 0);
ISPList[92]=new ISPitem("Thailand", "Samart", "PPPoE", "LLC", 0, 35, 0);
ISPList[93]=new ISPitem("Thailand", "TOT", "PPPoE", "LLC", 1, 32, 0);
ISPList[94]=new ISPitem("Thailand", "TRUE (Huawei)", "PPPoE", "LLC", 0, 100, 0);
ISPList[95]=new ISPitem("Thailand", "TT&T (Normal)", "PPPoE", "LLC", 0, 33, 0);
ISPList[96]=new ISPitem("Thailand", "TT&T (Hinet)", "PPPoE", "LLC", 0, 66, 0);
ISPList[97]=new ISPitem("Thailand", "Qnet", "PPPoE", "LLC", 0, 40, 0);
ISPList[98]=new ISPitem("Thailand", "UCOM", "PPPoE", "LLC", 0, 100, 0);

ISPList[99]=new ISPitem("Turkey", "TTNET(PPPoE)", "PPPoE", "LLC", 8, 35, 0);
ISPList[100]=new ISPitem("Turkey", "TTNET(PPPoA)", "PPPoA", "VCMUX", 8, 35, 0);
