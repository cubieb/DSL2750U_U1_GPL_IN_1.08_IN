var data_language = {
	innerHTML : {
		...
		lang_introduction : '您可以在本页配置ATM通道并选择服务类型。',
		...
		lang_protocol : '协议：',
		lang_encap : '封装方式：',
		lang_vlan_set : '(0 = 不使用, 1 - 4094)',
		lang_configproxyarp : '开启ARP代理',
		lang_enableFirewall : '开启防火墙',
		...
		lang_ip_mask : '子网掩码：',
		lang_ip_gw :'默认网关：',
		lang_ip6_ip :'WAN IP6 地址：',
		lang_ip6_prefix :'WAN IP6 前缀：',
		...
		lang_servicetype_1 : '服务类型：', 
		lang_servicetype_2 : '服务类型：', 
		lang_SELECT_Protocol_R : '协议类型：',
