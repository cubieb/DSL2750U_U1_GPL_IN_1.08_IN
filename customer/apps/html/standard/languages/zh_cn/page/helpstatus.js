var data_language = {
		innerHTML : {
			...
			lang_log_help : '<p>如果开启日志功能，系统会根据的选择的等级记录事件，选择等级包括“Emergency”“Alert”、“Critical”、“Error”、“Warning”、“Notice”、“Informational”、“Debugging”。所有等于或高于选择的等级的事件都将被记录。</p><p>您可以在 <a href="/cgi-bin/webproc?getpage=html/index.html&var:menu=maintenance&var:page=syslog">维护 -> 系统日志</a>页面设置系统日志</p>',
