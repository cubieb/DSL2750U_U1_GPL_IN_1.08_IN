...
$.extend($[iphoneStyle].prototype, {
  ...
  attachEvents: function() {
	...
	//Efect for onmouseover on handle
	this.container.mouseover( function(event, x) {
		 jQuery(obj.handle).addClass("over");
	});
	this.container.mouseout( function(event, x) {
		 jQuery(obj.handle).removeClass("over");
	});
  ...
  initialPosition: function() {
    this.offLabel.css({ width: this.container.width() - 0 });
