...
#ifndef CONFIG_APPS_CLI_SEPARATE_AUTH
ULONG CLI_Authenticate(char *szUsername, char *szPassword);
#endif
...
int CLI_GetNextLevelPath(char *szPathName, char aszNextLevel[CLI_MAX_OBJ_NUM][CLI_LEAF__LEN]);
