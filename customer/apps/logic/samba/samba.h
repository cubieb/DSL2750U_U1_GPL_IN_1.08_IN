...
/* 正则 */
#define SAMBA_REGEX_PREFIX			    "^InternetGatewayDevice\\.X_TWSZ-COM_SAMBA\\."

/* 节点路径定义 */
#define SAMBA_PATH_PREFIX		        "InternetGatewayDevice.X_TWSZ-COM_SAMBA."

#define NODE_SambaEnable		         "SambaEnable"
#define NODE_Workgroup				  "Workgroup"
...
*******************************************************************/
/* Init and Destroy */
int SAMBA_ModuleInit(void);
int SAMBA_ModuleDestroy(void);
