/**********************************************************************
 ...
 文件名称: rtl8672_dsl_api_wrapper.h
 文件描述: rtl8672 dsl HAL
...
#ifndef __RTL8672_DSL_API_WRAPPER_H__
#define __RTL8672_DSL_API_WRAPPER_H__

#include "../dsl_api.h"

//#define RTL8672_DEBUG 1
...
//RLCM_GET_XDSL_MODE	
#define XDSL_MODE_SIZE (sizeof(unsigned char))
//RLCM_SET_OLR_TYPE
...
#define GET_US_ERROR_COUNT_SIZE (sizeof(unsigned short)*2)
//RLCM_GET_DIAG_QLN		
//RLCM_GET_DIAG_HLOG		
//RLCM_GET_DIAG_SNR		
#define GET_DIAG_SIZE (sizeof(unsigned short)*TONE_RANGE)
//RLCM_GET_DS_PMS_PARAM1		
//RLCM_GET_US_PMS_PARAM1		
#define GET_PMS_SIZE (sizeof(unsigned short)*5)
//RLCM_SET_ANNEX_L		
//RLCM_GET_ANNEX_L		
#define GET_ANNEX_L_SIZE (sizeof(int))
//RLCM_GET_LINK_POWER_STATE	
...
#define RLCM_DRIVER_BUILD_SIZE		32
...
typedef struct {
	unsigned int	downstreamSNR;
	unsigned int	upstreamSNR;
} Modem_SNRMargin;
#define RLCM_GET_SNR_MARGIN_SIZE 	sizeof(Modem_SNRMargin)
...
*/
typedef struct {
  unsigned long  FecNotInterleaved;
  unsigned long  FecInterleaved;
  unsigned long  CrcNotInterleaved;
  unsigned long  CrcInterleaved;
  unsigned long  HecNotInterleaved;
  unsigned long  HecInterleaved;
  unsigned long  TotalCellCountInterleaved;
  unsigned long  TotalCellCountNotInterleaved;
  unsigned long  ActiveCellCountInterleaved;
  unsigned long  ActiveCellCountNotInterleaved;
  unsigned long  BERInterleaved;
  unsigned long  BERNotInterleaved;
} Modem_def_counters;
...
typedef enum {
	...
	ADSL_GET_TBS,
	ADSL_GET_CELL_DELIN,
	ADSL_GET_LINK_RETRAIN,
	ADSL_GET_INIT_ERR,
	ADSL_GET_INIT_TIMEOUT,
	ADSL_GET_LOSS_Of_FRAMING,
	ADSL_GET_ERR_SECS,
	ADSL_GET_ATU_ERR_SECS,
	ADSL_GET_SEV_ERR_SECS,
	ADSL_GET_SEV_ATU_ERR_SECS,
    ADSL_GET_FEC_ERR,
    ADSL_GET_ATU_FEC_ERR,
    ADSL_GET_HEC_ERR,
    ADSL_GET_ATUCHEC_ERR,
    ADSL_GET_CRC_ERR,
    ADSL_GET_ATUCCRC_ERR,

    ADSL_GET_layer_DS, //yuan
	ADSL_GET_layer_US //yuan
...
int rtl8672_DSL_GetDSLInfo(const char *pcName, char *pcValue,int len);
